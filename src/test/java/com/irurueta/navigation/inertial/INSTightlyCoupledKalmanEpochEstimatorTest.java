...
public class INSTightlyCoupledKalmanEpochEstimatorTest {
    ...
    public void testEstimate() throws AlgebraException {
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final NEDFrame userNedFrame = new NEDFrame(userLatitude, userLongitude, userHeight, userVn, userVe, userVd);
            final ECEFFrame userEcefFrame = NEDtoECEFFrameConverter.convertNEDtoECEFAndReturnNew(userNedFrame);
            ...
            for (int i = 0; i < numMeasurements; i++) {
                final double satLatitude = Math.toRadians(randomizer.nextDouble(MIN_LATITUDE_DEGREES,
                        MAX_LATITUDE_DEGREES));
                final double satLongitude = Math.toRadians(randomizer.nextDouble(MIN_LONGITUDE_DEGREES,
                        MAX_LONGITUDE_DEGREES));
                final double satHeight = randomizer.nextDouble(MIN_SAT_HEIGHT_METERS, MAX_SAT_HEIGHT_METERS);

                final double satVn = randomizer.nextDouble(MIN_SAT_SPEED_VALUE, MAX_SAT_SPEED_VALUE);
                final double satVe = randomizer.nextDouble(MIN_SAT_SPEED_VALUE, MAX_SAT_SPEED_VALUE);
                final double satVd = randomizer.nextDouble(MIN_SAT_SPEED_VALUE, MAX_SAT_SPEED_VALUE);

                final NEDFrame satNedFrame = new NEDFrame(satLatitude, satLongitude, satHeight, satVn, satVe, satVd);
                final ECEFFrame satEcefFrame = NEDtoECEFFrameConverter.convertNEDtoECEFAndReturnNew(satNedFrame);
            ...
            final INSTightlyCoupledKalmanState previousState = new INSTightlyCoupledKalmanState(
            ...
            final INSTightlyCoupledKalmanConfig config = new INSTightlyCoupledKalmanConfig(gyroNoisePSD,
            ...
            final INSTightlyCoupledKalmanState result2 = INSTightlyCoupledKalmanEpochEstimator.estimate(measurements,
            ...
            final INSTightlyCoupledKalmanState result4 = INSTightlyCoupledKalmanEpochEstimator.estimate(measurements,
            ...
            final INSTightlyCoupledKalmanState result6 = INSTightlyCoupledKalmanEpochEstimator.estimate(measurements,
            ...
            final INSTightlyCoupledKalmanState result8 = INSTightlyCoupledKalmanEpochEstimator.estimate(measurements,
            ...
            final INSTightlyCoupledKalmanState result10 = INSTightlyCoupledKalmanEpochEstimator.estimate(measurements,
            ...
            final INSTightlyCoupledKalmanState result12 = INSTightlyCoupledKalmanEpochEstimator.estimate(measurements,
            ...
            final INSTightlyCoupledKalmanState result14 = INSTightlyCoupledKalmanEpochEstimator.estimate(measurements,
            ...
            final INSTightlyCoupledKalmanState result16 = INSTightlyCoupledKalmanEpochEstimator.estimate(measurements,
            ...
            final INSTightlyCoupledKalmanState result18 = INSTightlyCoupledKalmanEpochEstimator.estimate(measurements,
            ...
            final INSTightlyCoupledKalmanState result20 = INSTightlyCoupledKalmanEpochEstimator.estimate(measurements,
            ...
            final INSTightlyCoupledKalmanState result22 = INSTightlyCoupledKalmanEpochEstimator.estimate(measurements,
            ...
            final INSTightlyCoupledKalmanState result24 = INSTightlyCoupledKalmanEpochEstimator.estimate(measurements,
            ...
            final INSTightlyCoupledKalmanState expected = estimate(measurements, previousState, fx, fy, fz,
    ...
    private static INSTightlyCoupledKalmanState estimate(
        ...
        for (int j = 0; j < noMeas; j++) {
            ...
            final double approxRange = Math.sqrt(Utils.dotProduct(deltaR.transposeAndReturnNew(), deltaR));
            ...
            final double range = Math.sqrt(Utils.dotProduct(deltaR.transposeAndReturnNew(), deltaR));
            ...
            final Matrix rangeRate = uAseT.getSubmatrix(j, 0, j, 2).multiplyAndReturnNew(
        ...
        final Matrix estCbeNew = Matrix.identity(3, 3).subtractAndReturnNew(Utils.skewMatrix(
        ...
        final Matrix estClockNew = xEstNew.getSubmatrix(
                15, 0, 16, 0);
