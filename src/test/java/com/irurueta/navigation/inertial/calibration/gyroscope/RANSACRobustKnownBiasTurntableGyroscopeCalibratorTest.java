...
class RANSACRobustKnownBiasTurntableGyroscopeCalibratorTest implements
    ...
    void testConstructor1() throws WrongSizeException {
        final var calibrator = new RANSACRobustKnownBiasTurntableGyroscopeCalibrator();

        // check default values
        assertEquals(RANSACRobustKnownBiasTurntableGyroscopeCalibrator.DEFAULT_THRESHOLD, calibrator.getThreshold(),
                0.0);
    ...
    void testConstructor2() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustKnownBiasTurntableGyroscopeCalibrator(ecefPosition, rotationRate,
        ...
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustKnownBiasTurntableGyroscopeCalibrator(
    ...
    void testConstructor18() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustKnownBiasTurntableGyroscopeCalibrator(nedPosition, rotationRate,
                timeInterval, measurements, bg, mg, gg);
    ...
    void testGetSetProgressDelta() throws LockedException {
        ...
        // check default value
        assertEquals(RANSACRobustKnownBiasTurntableGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA,
    ...
    void testGetSetConfidence() throws LockedException {
        ...
        // check default value
        assertEquals(RANSACRobustKnownBiasTurntableGyroscopeCalibrator.DEFAULT_CONFIDENCE, calibrator.getConfidence(),
                0.0);
    ...
    void testGetSetMaxIterations() throws LockedException {
        ...
        // check default value
        assertEquals(RANSACRobustKnownBiasTurntableGyroscopeCalibrator.DEFAULT_MAX_ITERATIONS, 
