...
class PROSACRobustKnownGravityNormAccelerometerCalibratorTest implements 
    ...
    void testConstructor1() throws WrongSizeException {
        final var calibrator = new PROSACRobustKnownGravityNormAccelerometerCalibrator();

        // check default values
        assertEquals(PROSACRobustKnownGravityNormAccelerometerCalibrator.DEFAULT_THRESHOLD, calibrator.getThreshold(),
                0.0);
        assertEquals(PROSACRobustKnownGravityNormAccelerometerCalibrator.DEFAULT_COMPUTE_AND_KEEP_INLIERS,
                calibrator.isComputeAndKeepInliersEnabled());
        assertEquals(PROSACRobustKnownGravityNormAccelerometerCalibrator.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS,
    ...
    void testConstructor2() throws WrongSizeException {
        final var calibrator = new PROSACRobustKnownGravityNormAccelerometerCalibrator(this);
    ...
    void testConstructor3() throws WrongSizeException {
        ...
        final var calibrator = new PROSACRobustKnownGravityNormAccelerometerCalibrator(measurements);
    ...
    void testConstructor4() throws WrongSizeException {
        final var calibrator = new PROSACRobustKnownGravityNormAccelerometerCalibrator(true);

        // check default values
        assertEquals(PROSACRobustKnownGravityNormAccelerometerCalibrator.DEFAULT_THRESHOLD,
    ...
    void testConstructor5() throws WrongSizeException {
        ...
        final var calibrator = new PROSACRobustKnownGravityNormAccelerometerCalibrator(bias);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                new double[1]));
    }
    ...
    void testConstructor6() throws WrongSizeException {
        ...
        final var calibrator = new PROSACRobustKnownGravityNormAccelerometerCalibrator(ba);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(m1));
        final var m2 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(m2));
    }
    ...
    void testConstructor7() throws WrongSizeException {
        ...
        final var calibrator = new PROSACRobustKnownGravityNormAccelerometerCalibrator(ba, ma);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(ba,
                m3));
    ...
    void testConstructor8() throws WrongSizeException {
        ...
        final var calibrator = new PROSACRobustKnownGravityNormAccelerometerCalibrator(gravityNorm);
    ...
    void testConstructor9() throws WrongSizeException {
        ...
        final var calibrator = new PROSACRobustKnownGravityNormAccelerometerCalibrator(gravityNorm, measurements);
    ...
    void testConstructor13() throws WrongSizeException {
        ...
        final var calibrator = new PROSACRobustKnownGravityNormAccelerometerCalibrator(gravityNorm, measurements, bias);
    ...
    void testConstructor17() throws WrongSizeException {
        ...
        final var calibrator = new PROSACRobustKnownGravityNormAccelerometerCalibrator(gravityNorm, measurements, ba);
    ...
    void testConstructor34() throws WrongSizeException {
        ...
        assertEquals(gravity.getNorm(), calibrator.getGroundTruthGravityNorm(), ABSOLUTE_ERROR);
        assertNotNull(calibrator.getGroundTruthGravityNormAsAcceleration());
        assertTrue(calibrator.getGroundTruthGravityNormAsAcceleration().equals(gravity.getNormAsAcceleration(), ABSOLUTE_ERROR));
        final var g = new Acceleration(0.0, AccelerationUnit.G);
        assertTrue(calibrator.getGroundTruthGravityNormAsAcceleration(g));
        assertTrue(gravity.getNormAsAcceleration().equals(g, ABSOLUTE_ERROR));
        assertEquals(0.0, calibrator.getEstimatedMse(), 0.0);
    ...
    void testConstructor42() throws WrongSizeException {
        ...
        final var calibrator = new PROSACRobustKnownGravityNormAccelerometerCalibrator(qualityScores, gravityNorm,
                measurements);
    ...
    void testConstructor44() throws WrongSizeException {
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                new double[9], gravityNorm, measurements, true));
    }
    ...
    void testConstructor45() throws WrongSizeException {
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                new double[9], gravityNorm, measurements, true, this));
    }
    ...
    void testConstructor47() throws WrongSizeException {
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                new double[12], gravityNorm, measurements, bias, this));
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, new double[1], this));
    }
    ...
    void testConstructor48() throws WrongSizeException {
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                new double[9], gravityNorm, measurements, true, bias));
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, true, new double[1]));
    }
    ...
    void testConstructor49() throws WrongSizeException {
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                new double[9], gravityNorm, measurements, true, bias, this));
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
    ...
    void testConstructor50() throws WrongSizeException {
        ...
        final var m1 = new Matrix(1, 1);
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, m1));
        final var m2 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, m2));
    }
    ...
    void testConstructor51() throws WrongSizeException {
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                new double[12], gravityNorm, measurements, ba, this));
        final var m1 = new Matrix(1, 1);
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, m1, this));
        final var m2 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, m2, this));
    }
    ...
    void testConstructor52() throws WrongSizeException {
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                new double[9], gravityNorm, measurements, true, ba));
        final var m1 = new Matrix(1, 1);
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, true, m1));
        final var m2 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, true, m2));
    }
    ...
    void testConstructor53() throws WrongSizeException {
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                new double[9], gravityNorm, measurements, true, ba, this));
        final var m1 = new Matrix(1, 1);
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, true, m1, this));
        final var m2 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, true, m2, this));
    }
    ...
    void testConstructor54() throws WrongSizeException {
        ...
        final var m1 = new Matrix(1, 1);
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, m1, ma));
        final var m2 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, m2, ma));
        final var m3 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, ba, m3));
        final var m4 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, ba, m4));
    }
    ...
    void testConstructor55() throws WrongSizeException {
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                new double[12], gravityNorm, measurements, ba, ma, this));
        final var m1 = new Matrix(1, 1);
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, m1, ma, this));
        final var m2 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, m2, ma, this));
        final var m3 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, ba, m3, this));
        final var m4 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, ba, m4, this));
    }
    ...
    void testConstructor56() throws WrongSizeException {
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                new double[9], gravityNorm, measurements, true, ba, ma));
        final var m1 = new Matrix(1, 1);
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, true, m1, ma));
        final var m2 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, true, m2, ma));
        final var m3 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, true, ba, m3));
        final var m4 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, true, ba, m4));
    }
    ...
    void testConstructor57() throws WrongSizeException {
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                new double[9], gravityNorm, measurements, true, ba, ma, this));
        final var m1 = new Matrix(1, 1);
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, true, m1, ma, this));
        final var m2 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, true, m2, ma, this));
        final var m3 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, true, ba, m3, this));
        final var m4 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, true, ba, m4, this));
    }
    ...
    void testConstructor66() throws WrongSizeException {
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                new double[9], gravityNorm, measurements, true, bias, this));
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownGravityNormAccelerometerCalibrator(
                qualityScores, gravityNorm, measurements, true, new double[1], this));
    }
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        ...
        // check default value
        assertEquals(PROSACRobustKnownGravityNormAccelerometerCalibrator.MINIMUM_MEASUREMENTS_GENERAL,
                calibrator.getPreliminarySubsetSize());
    ...
    void testCalibrateGeneralNoNoiseInlier() throws WrongSizeException, InvalidSourceAndDestinationFrameTypeException, 
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var calibrator = new PROSACRobustKnownGravityNormAccelerometerCalibrator(qualityScores,
                    gravity.getNorm(), measurements, false, ba, ma, this);
    ...
    void testCalibrateCommonAxisNoNoiseInlier() throws WrongSizeException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var calibrator = new PROSACRobustKnownGravityNormAccelerometerCalibrator(qualityScores,
                    gravity.getNorm(), measurements, true, ba, ma, this);
            calibrator.setThreshold(THRESHOLD);
    ...
    void testCalibrateCommonAxisWithInlierNoise() throws WrongSizeException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var calibrator = new PROSACRobustKnownGravityNormAccelerometerCalibrator(qualityScores,
                    gravity.getNorm(), measurements, true, this);
            calibrator.setThreshold(LARGE_THRESHOLD);
    ...
    private static void assertEstimatedResult(
            final Matrix ba, final Matrix ma, final PROSACRobustKnownGravityNormAccelerometerCalibrator calibrator,
    ...
    private static void assertCovariance(final PROSACRobustKnownGravityNormAccelerometerCalibrator calibrator) {
