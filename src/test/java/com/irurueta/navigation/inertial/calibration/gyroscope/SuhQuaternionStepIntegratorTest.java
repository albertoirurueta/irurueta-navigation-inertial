...
class SuhQuaternionStepIntegratorTest {
    ...
    void integrate_whenOneStep_computesExpectedResult() throws RotationException {
        ...
        final var integrator = new SuhQuaternionStepIntegrator();
        final var result1 = new Quaternion();
        final var result2 = new Quaternion();
        SuhQuaternionStepIntegrator.integrationStep(initialAttitude, wx, wy, wz, wx, wy, wz, TIME_INTERVAL, result1);
    ...
    void integrate_whenMultipleSteps_computesExpectedResult() throws RotationException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            for (var i = 0; i < NUM_SAMPLES; i++) {
                SuhQuaternionStepIntegrator.integrationStep(result1, wx, wy, wz, wx, wy, wz, TIME_INTERVAL, result1);
