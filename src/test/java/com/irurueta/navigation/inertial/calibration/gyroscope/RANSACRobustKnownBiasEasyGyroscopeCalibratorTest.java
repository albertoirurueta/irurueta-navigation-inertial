...
class RANSACRobustKnownBiasEasyGyroscopeCalibratorTest implements
    ...
    void testConstructor1() throws WrongSizeException {
        final var calibrator = new RANSACRobustKnownBiasEasyGyroscopeCalibrator();
        ...
        assertEquals(RANSACRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA,
                calibrator.getProgressDelta(), 0.0);
        assertEquals(RANSACRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_CONFIDENCE, calibrator.getConfidence(), 
                0.0);
        assertEquals(RANSACRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_MAX_ITERATIONS,
        ...
        assertEquals(RANSACRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_THRESHOLD, calibrator.getThreshold(),
                0.0);
    ...
    void testConstructor2() throws WrongSizeException {
        ...
        final var calibrator =
                new RANSACRobustKnownBiasEasyGyroscopeCalibrator(sequences, bg, mg, gg);
        ...
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustKnownBiasEasyGyroscopeCalibrator(
                sequences, m1, mg, gg));
    ...
    void testConstructor3() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustKnownBiasEasyGyroscopeCalibrator(sequences, bg, mg, gg, this);
        ...
        assertEquals(RANSACRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA, calibrator.getProgressDelta(),
                0.0);
        assertEquals(RANSACRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_CONFIDENCE, calibrator.getConfidence(),
                0.0);
        assertEquals(RANSACRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_MAX_ITERATIONS,
        ...
        final var m1 = new Matrix(1, 1);
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustKnownBiasEasyGyroscopeCalibrator(sequences,
                m1, mg, gg, this));
        final var m2 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustKnownBiasEasyGyroscopeCalibrator(sequences,
                m2, mg, gg, this));
    ...
    void testConstructor4() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustKnownBiasEasyGyroscopeCalibrator(sequences, bias, mg, gg);
    ...
    void testConstructor5() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustKnownBiasEasyGyroscopeCalibrator(sequences, bias, mg, gg, this);
    ...
    void testConstructor6() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustKnownBiasEasyGyroscopeCalibrator(sequences, bias, mg, gg, baArray, ma);
    ...
    void testConstructor8() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustKnownBiasEasyGyroscopeCalibrator(sequences, bg, mg, gg, ba, ma);
    ...
    void testConstructor10() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustKnownBiasEasyGyroscopeCalibrator(sequences, false,
                false, bg, mg, gg);
    ...
    void testConstructor11() throws WrongSizeException {
        ...
        assertEquals(RANSACRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA,
                calibrator.getProgressDelta(), 0.0);
        assertEquals(RANSACRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_CONFIDENCE, calibrator.getConfidence(), 0.0);
        assertEquals(RANSACRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_MAX_ITERATIONS,
                calibrator.getMaxIterations());
        assertNull(calibrator.getInliersData());
        assertTrue(calibrator.isResultRefined());
        assertTrue(calibrator.isCovarianceKept());
        assertNull(calibrator.getQualityScores());
        assertEquals(RANSACRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_THRESHOLD, calibrator.getThreshold(), 0.0);
        assertFalse(calibrator.isComputeAndKeepInliersEnabled());
        assertFalse(calibrator.isComputeAndKeepResiduals());
        assertEquals(EasyGyroscopeCalibrator.MINIMUM_SEQUENCES_GENERAL_AND_CROSS_BIASES,
                calibrator.getPreliminarySubsetSize());
    ...
    void testSetAccelerometerScalingFactorsAndCrossCouplingErrors() throws WrongSizeException, LockedException {
        ...
        calibrator.setAccelerometerScalingFactorsAndCrossCouplingErrors(sxa, sya, sza, mxya, mxza, myxa,
                myza, mzxa, mzya);
    ...
    void testCalibrateCommonAxisAndGDependentCrossBiasesDisabledAndNoInlierNoise() throws WrongSizeException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            for (var i = 0; i < MEASUREMENT_NUMBER; i++) {
                ...
                final var newNedC = new CoordinateTransformation(afterQ.asInhomogeneousMatrix(),
            ...
            final var calibrator = new RANSACRobustKnownBiasEasyGyroscopeCalibrator(sequences, true,
                    false, bg, mg, gg, ba, ma, this);
    ...
    private static void checkLocked(final RANSACRobustKnownBiasEasyGyroscopeCalibrator calibrator) {
