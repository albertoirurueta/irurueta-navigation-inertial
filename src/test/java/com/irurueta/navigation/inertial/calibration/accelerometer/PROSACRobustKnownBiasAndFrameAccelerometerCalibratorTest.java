...
class PROSACRobustKnownBiasAndFrameAccelerometerCalibratorTest implements
    ...
    void testConstructor25() throws WrongSizeException {
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownBiasAndFrameAccelerometerCalibrator(
                new double[1]));
    }
    ...
    private static void assertEstimatedResult(
            final Matrix ma, final PROSACRobustKnownBiasAndFrameAccelerometerCalibrator calibrator) {
