...
public class MSACRobustKnownBiasEasyGyroscopeCalibratorTest implements RobustKnownBiasEasyGyroscopeCalibratorListener {
    ...
    public void testConstructor1() throws WrongSizeException {
        final MSACRobustKnownBiasEasyGyroscopeCalibrator calibrator = new MSACRobustKnownBiasEasyGyroscopeCalibrator();
    ...
    public void testConstructor2() throws WrongSizeException {
        ...
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustKnownBiasEasyGyroscopeCalibrator(
                sequences, m1, mg, gg));
    ...
    public void testConstructor14() throws WrongSizeException {
        ...
        assertEquals(MSACRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_CONFIDENCE, calibrator.getConfidence(),
                0.0);
        assertEquals(MSACRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_MAX_ITERATIONS,
    ...
    public void testSetAccelerometerScalingFactorsAndCrossCouplingErrors() throws WrongSizeException, LockedException {
        ...
        calibrator.setAccelerometerScalingFactorsAndCrossCouplingErrors(sxa, sya, sza, mxya, mxza,
                myxa, myza, mzxa, mzya);
    ...
    public void testCalibrateCommonAxisAndGDependentCrossBiasesDisabledAndNoInlierNoise() throws WrongSizeException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final MSACRobustKnownBiasEasyGyroscopeCalibrator calibrator =
                    new MSACRobustKnownBiasEasyGyroscopeCalibrator(sequences, true,
    ...
    public void testCalibrateGeneralAndGDependentCrossBiasesDisabledAndNoInlierNoise() throws WrongSizeException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final MSACRobustKnownBiasEasyGyroscopeCalibrator calibrator =
                    new MSACRobustKnownBiasEasyGyroscopeCalibrator(sequences, false,
                            false, bg, mg, gg, ba, ma, this);
