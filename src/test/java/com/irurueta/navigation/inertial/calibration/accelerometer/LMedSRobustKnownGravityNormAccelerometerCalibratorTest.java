...
class LMedSRobustKnownGravityNormAccelerometerCalibratorTest implements 
    ...
    void testConstructor1() throws WrongSizeException {
        final var calibrator = new LMedSRobustKnownGravityNormAccelerometerCalibrator();

        // check default values
        assertEquals(LMedSRobustKnownGravityNormAccelerometerCalibrator.DEFAULT_STOP_THRESHOLD,
    ...
    void testConstructor2() throws WrongSizeException {
        final var calibrator = new LMedSRobustKnownGravityNormAccelerometerCalibrator(this);
    ...
    void testConstructor3() throws WrongSizeException {
        ...
        final var calibrator = new LMedSRobustKnownGravityNormAccelerometerCalibrator(measurements);
    ...
    void testConstructor4() throws WrongSizeException {
        final var calibrator = new LMedSRobustKnownGravityNormAccelerometerCalibrator(true);
    ...
    void testConstructor5() throws WrongSizeException {
        ...
        final var calibrator = new LMedSRobustKnownGravityNormAccelerometerCalibrator(bias);
        ...
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustKnownGravityNormAccelerometerCalibrator(
                new double[1]));
    }
    ...
    void testConstructor6() throws WrongSizeException {
        ...
        final var calibrator = new LMedSRobustKnownGravityNormAccelerometerCalibrator(ba);
        ...
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustKnownGravityNormAccelerometerCalibrator(m1));
        final var m2 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustKnownGravityNormAccelerometerCalibrator(m2));
    }
    ...
    void testConstructor7() throws WrongSizeException {
        ...
        final var calibrator = new LMedSRobustKnownGravityNormAccelerometerCalibrator(ba, ma);
    ...
    void testConstructor8() throws WrongSizeException {
        ...
        final var calibrator = new LMedSRobustKnownGravityNormAccelerometerCalibrator(gravityNorm);
    ...
    void testConstructor9() throws WrongSizeException {
        ...
        final var calibrator = new LMedSRobustKnownGravityNormAccelerometerCalibrator(gravityNorm, measurements);
    ...
    void testConstructor13() throws WrongSizeException {
        ...
        final var calibrator = new LMedSRobustKnownGravityNormAccelerometerCalibrator(gravityNorm, measurements, bias);
    ...
    void testConstructor17() throws WrongSizeException {
        ...
        final var calibrator = new LMedSRobustKnownGravityNormAccelerometerCalibrator(gravityNorm, measurements, ba);
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        ...
        // check default value
        assertEquals(LMedSRobustKnownGravityNormAccelerometerCalibrator.MINIMUM_MEASUREMENTS_GENERAL,
                calibrator.getPreliminarySubsetSize());
    ...
    void testCalibrateGeneralNoNoiseInlier() throws WrongSizeException, InvalidSourceAndDestinationFrameTypeException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var calibrator = new LMedSRobustKnownGravityNormAccelerometerCalibrator(gravity.getNorm(),
    ...
    private static void assertEstimatedResult(
            final Matrix ba, final Matrix ma, final LMedSRobustKnownGravityNormAccelerometerCalibrator calibrator,
    ...
    private static void assertCovariance(final LMedSRobustKnownGravityNormAccelerometerCalibrator calibrator) {
