...
class PROMedSRobustKnownFrameMagnetometerCalibratorTest implements RobustKnownFrameMagnetometerCalibratorListener {
    ...
    void testConstructor1() throws WrongSizeException {
        final var calibrator = new PROMedSRobustKnownFrameMagnetometerCalibrator();

        assertEquals(PROMedSRobustKnownFrameMagnetometerCalibrator.DEFAULT_STOP_THRESHOLD, 
    ...
    void testConstructor2() throws WrongSizeException {
        final var calibrator = new PROMedSRobustKnownFrameMagnetometerCalibrator(this);
    ...
    void testConstructor3() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownFrameMagnetometerCalibrator(measurements);
    ...
    void testConstructor4() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownFrameMagnetometerCalibrator(measurements, this);
    ...
    void testConstructor5() throws WrongSizeException {
        final var calibrator = new PROMedSRobustKnownFrameMagnetometerCalibrator(true);
    ...
    void testConstructor6() throws WrongSizeException {
        final var calibrator = new PROMedSRobustKnownFrameMagnetometerCalibrator(true, this);
    ...
    void testConstructor7() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownFrameMagnetometerCalibrator(measurements, true);
    ...
    void testConstructor9() throws WrongSizeException {
        final var qualityScores = new double[PROMedSRobustKnownFrameMagnetometerCalibrator.MINIMUM_MEASUREMENTS];
        final var calibrator = new PROMedSRobustKnownFrameMagnetometerCalibrator(qualityScores);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustKnownFrameMagnetometerCalibrator(
                new double[1]));
    }
    ...
    void testConstructor10() throws WrongSizeException {
        final var qualityScores = new double[PROMedSRobustKnownFrameMagnetometerCalibrator.MINIMUM_MEASUREMENTS];
        final var calibrator = new PROMedSRobustKnownFrameMagnetometerCalibrator(qualityScores, this);
    ...
    void testConstructor11() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownFrameMagnetometerCalibrator(qualityScores, measurements);
    ...
    void testConstructor13() throws WrongSizeException {
        final var qualityScores = new double[PROMedSRobustKnownFrameMagnetometerCalibrator.MINIMUM_MEASUREMENTS];
        final var calibrator = new PROMedSRobustKnownFrameMagnetometerCalibrator(qualityScores, true);
    ...
    void testGetSetQualityScores() throws LockedException {
        ...
        // set a new value
        final var qualityScores = new double[PROMedSRobustKnownFrameAccelerometerCalibrator.MINIMUM_MEASUREMENTS];
        calibrator.setQualityScores(qualityScores);
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        ...
        // check default value
        assertEquals(PROMedSRobustKnownFrameMagnetometerCalibrator.MINIMUM_MEASUREMENTS,
                calibrator.getPreliminarySubsetSize());
    ...
    private void checkLocked(final PROMedSRobustKnownFrameMagnetometerCalibrator calibrator) {
    ...
    private static void assertEstimatedResult(
            final Matrix hardIron, final Matrix mm, final PROMedSRobustKnownFrameMagnetometerCalibrator calibrator,
    ...
    private static void assertCovariance(final PROMedSRobustKnownFrameMagnetometerCalibrator calibrator) {
