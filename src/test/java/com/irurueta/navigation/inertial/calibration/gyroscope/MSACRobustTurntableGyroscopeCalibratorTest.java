...
public class MSACRobustTurntableGyroscopeCalibratorTest implements RobustTurntableGyroscopeCalibratorListener {
    ...
    public void testConstructor1() throws WrongSizeException {
        final MSACRobustTurntableGyroscopeCalibrator calibrator = new MSACRobustTurntableGyroscopeCalibrator();
    ...
    public void testConstructor3() throws WrongSizeException {
        ...
        // check default values
        assertEquals(MSACRobustTurntableGyroscopeCalibrator.DEFAULT_THRESHOLD,
    ...
    public void testConstructor15() throws WrongSizeException {
        ...
        final MSACRobustTurntableGyroscopeCalibrator calibrator =
                new MSACRobustTurntableGyroscopeCalibrator(ecefPosition, rotationRate, timeInterval, measurements,
        ...
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustTurntableGyroscopeCalibrator(ecefPosition,
                ...
                true, false, new double[1], mg, gg, accelerometerBias, ma,
                this));
        final var m1 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustTurntableGyroscopeCalibrator(ecefPosition,
                rotationRate, timeInterval, measurements, true, false, bias,
