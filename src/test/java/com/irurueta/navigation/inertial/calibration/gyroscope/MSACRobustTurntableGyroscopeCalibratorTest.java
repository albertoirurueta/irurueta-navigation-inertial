...
class MSACRobustTurntableGyroscopeCalibratorTest implements RobustTurntableGyroscopeCalibratorListener {
    ...
    void testConstructor1() throws WrongSizeException {
        final var calibrator = new MSACRobustTurntableGyroscopeCalibrator();

        // check default values
        assertEquals(MSACRobustTurntableGyroscopeCalibrator.DEFAULT_THRESHOLD, calibrator.getThreshold(), 0.0);
    ...
    void testConstructor2() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustTurntableGyroscopeCalibrator(ecefPosition, rotationRate, timeInterval,
    ...
    void testConstructor18() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustTurntableGyroscopeCalibrator(nedPosition, rotationRate, timeInterval,
                measurements, bg, mg, gg);
    ...
    void testConstructor31() throws WrongSizeException {
        ...
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustTurntableGyroscopeCalibrator(nedPosition,
                rotationRate, timeInterval, measurements, true, false,
                bias, mg, gg, accelerometerBias, m5, this));
        final var m6 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustTurntableGyroscopeCalibrator(nedPosition,
                rotationRate, timeInterval, measurements, true, false, bias,
                mg, gg, accelerometerBias, m6, this));
    ...
    void testGetSetProgressDelta() throws LockedException {
        ...
        // check default value
        assertEquals(MSACRobustTurntableGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA, calibrator.getProgressDelta(),
                0.0);
    ...
    void testGetSetConfidence() throws LockedException {
        ...
        // check default value
        assertEquals(MSACRobustTurntableGyroscopeCalibrator.DEFAULT_CONFIDENCE, calibrator.getConfidence(), 0.0);
    ...
    void testGetSetMaxIterations() throws LockedException {
        ...
        // check default value
        assertEquals(MSACRobustTurntableGyroscopeCalibrator.DEFAULT_MAX_ITERATIONS, calibrator.getMaxIterations());
    ...
    void testCalibrateGeneralAndGDependentCrossBiasesEnabledAndNoInlierNoise() throws WrongSizeException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            for (int i = 0; i < MEASUREMENT_NUMBER; i++) {
                ...
                final var nedC1 = new CoordinateTransformation(roll1, pitch1, yaw1,
    ...
    private static void assertEstimatedResult(
            final Matrix bg, final Matrix mg, final Matrix gg, final MSACRobustTurntableGyroscopeCalibrator calibrator,
    ...
    private static void assertCovariance(final MSACRobustTurntableGyroscopeCalibrator calibrator) {
