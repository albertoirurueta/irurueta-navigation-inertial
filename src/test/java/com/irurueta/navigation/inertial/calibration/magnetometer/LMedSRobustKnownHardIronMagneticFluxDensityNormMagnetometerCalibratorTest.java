...
class LMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibratorTest implements
    ...
    void testConstructor1() throws WrongSizeException {
        final var calibrator = new LMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator();

        // check default values
        assertEquals(LMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator.DEFAULT_STOP_THRESHOLD,
        ...
        assertEquals(LMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator.DEFAULT_PROGRESS_DELTA,
                calibrator.getProgressDelta(), 0.0f);
        assertEquals(LMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator.DEFAULT_CONFIDENCE,
                calibrator.getConfidence(), 0.0);
        assertEquals(LMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator.DEFAULT_MAX_ITERATIONS,
    ...
    void testConstructor2() throws WrongSizeException {
        final var calibrator = new LMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator(this);
    ...
    void testConstructor3() throws WrongSizeException {
        ...
        final var calibrator = new LMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator(measurements);
    ...
    void testConstructor5() throws WrongSizeException {
        ...
        final var calibrator = new LMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator(hardIron);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator(new double[1]));
    }
    ...
    void testConstructor6() throws WrongSizeException {
        ...
        final var calibrator = new LMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator(bm);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator(m1));
        final var m2 = new Matrix(1, 1);
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator(m2));
    }
    ...
    void testConstructor7() throws WrongSizeException {
        ...
        final var calibrator = new LMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator(bm, mm);
        ...
        final var m1 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator(m1, mm));
        final var m2 = new Matrix(1, 1);
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator(m2, mm));
        final var m3 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator(bm, m3));
        final var m4 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator(bm, m4));
    }
    ...
    void testConstructor11() throws WrongSizeException {
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator(measurements,
                        new double[1]));
    }
    ...
    void testConstructor15() throws WrongSizeException {
        ...
        final var m1 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator(measurements, m1));
        final var m2 = new Matrix(1, 1);
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator(measurements, m2));
    }
    ...
    void testConstructor19() throws WrongSizeException {
        ...
        final var m1 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator(measurements, m1, mm));
        final var m2 = new Matrix(1, 1);
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator(measurements, m2, mm));
        final var m3 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator(measurements, bm, m3));
        final var m4 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator(measurements, bm, m4));
    }
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        ...
        // check default value
        assertEquals(LMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator.MINIMUM_MEASUREMENTS_GENERAL,
    ...
    private static List<StandardDeviationBodyMagneticFluxDensity> generateMeasures(
        ...
        for (var i = 0; i < numberOfMeasurements; i++) {
            final var cnb = generateBodyC(randomizer);
            result.add(generateMeasure(hardIron, softIron, wmmEstimator, null, position, timestamp, cnb));
        }
        return result;
    }
