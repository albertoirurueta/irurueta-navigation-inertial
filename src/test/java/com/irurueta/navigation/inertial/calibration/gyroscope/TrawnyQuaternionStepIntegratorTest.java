...
class TrawnyQuaternionStepIntegratorTest {
    ...
    void integrate_whenOneStep_computesExpectedResult() throws RotationException {
        ...
        final var integrator = new TrawnyQuaternionStepIntegrator();
    ...
    void compareErrors_whenNoNoise_haveExpectedRelativeAccuracy() throws RotationException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var resultYuanAngles = result3.toEulerAngles();
            final var resultEulerAngles = result4.toEulerAngles();
            final var resultMidPointEulerAngles = result5.toEulerAngles();
            final var resultRungeKuttaEulerAngles = result6.toEulerAngles();
            ...
            Logger.getLogger(TrawnyQuaternionStepIntegratorTest.class.getName()).log(Level.INFO,
            ...
            Logger.getLogger(TrawnyQuaternionStepIntegratorTest.class.getName()).log(Level.INFO,
                    String.format("Runge-Kutta error: %f radians", error5));
