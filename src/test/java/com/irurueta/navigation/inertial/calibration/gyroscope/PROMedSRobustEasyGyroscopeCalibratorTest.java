...
public class PROMedSRobustEasyGyroscopeCalibratorTest implements RobustEasyGyroscopeCalibratorListener {
    ...
    public void testConstructor2() throws WrongSizeException {
        ...
        final PROMedSRobustEasyGyroscopeCalibrator calibrator = new PROMedSRobustEasyGyroscopeCalibrator(sequences,
                bg, mg, gg);
    ...
    public void testConstructor4() throws WrongSizeException {
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustEasyGyroscopeCalibrator(sequences, bias,
                m1, gg));
    ...
    public void testConstructor7() throws WrongSizeException {
        ...
        final var m1 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustEasyGyroscopeCalibrator(sequences, bias,
                m1, gg, baArray, ma, this));
        final var m2 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustEasyGyroscopeCalibrator(sequences, bias,
                m2, gg, baArray, ma, this));
        final var m3 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustEasyGyroscopeCalibrator(sequences, bias,
                mg, m3, baArray, ma, this));
        final var m4 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustEasyGyroscopeCalibrator(sequences, bias,
                mg, m4, baArray, ma, this));
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustEasyGyroscopeCalibrator(sequences, bias,
                mg, gg, new double[1], ma, this));
        final var m5 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustEasyGyroscopeCalibrator(sequences, bias,
                mg, gg, baArray, m5, this));
        final var m6 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustEasyGyroscopeCalibrator(sequences, bias,
                mg, gg, baArray, m6, this));
    }
    ...
    public void testConstructor8() throws WrongSizeException {
        ...
        final PROMedSRobustEasyGyroscopeCalibrator calibrator = new PROMedSRobustEasyGyroscopeCalibrator(sequences, bg,
                mg, gg, ba, ma);
    ...
    public void testConstructor15() throws WrongSizeException {
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustEasyGyroscopeCalibrator(sequences,
                false, false, new double[1], mg, gg, baArray, ma, this));
        final var m1 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustEasyGyroscopeCalibrator(sequences,
    ...
    public void testConstructor18() throws WrongSizeException {
        ...
        final PROMedSRobustEasyGyroscopeCalibrator calibrator = new PROMedSRobustEasyGyroscopeCalibrator(qualityScores);
        ...
        assertEquals(PROMedSRobustEasyGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA,
    ...
    public void testCalibrateCommonAxisAndGDependentCrossBiasesDisabledAndNoInlierNoise() throws WrongSizeException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final PROMedSRobustEasyGyroscopeCalibrator calibrator = new PROMedSRobustEasyGyroscopeCalibrator(
                    qualityScores, sequences, true, false, bg, mg, gg, ba, ma,
                    this);
    ...
    public void testCalibrateGeneralAndGDependentCrossBiasesDisabledAndNoInlierNoise() throws WrongSizeException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final PROMedSRobustEasyGyroscopeCalibrator calibrator = new PROMedSRobustEasyGyroscopeCalibrator(
                    qualityScores, sequences, false, false, bg, mg, gg, ba,
                    ma, this);
    ...
    public void testCalibrateCommonAxisAndGDependentCrossBiasesEnabledAndNoInlierNoise() throws WrongSizeException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final PROMedSRobustEasyGyroscopeCalibrator calibrator = new PROMedSRobustEasyGyroscopeCalibrator(
                    qualityScores, sequences, true, true, bg, mg, gg, ba, ma,
                    this);
    ...
    public void testCalibrateGeneralAndGDependentCrossBiasesEnabledAndNoInlierNoise() throws WrongSizeException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final PROMedSRobustEasyGyroscopeCalibrator calibrator = new PROMedSRobustEasyGyroscopeCalibrator(
                    qualityScores, sequences, false, true, bg, mg, gg, ba, ma,
                    this);
            ...
            for (int i = 0; i < MEASUREMENT_NUMBER; i++) {
                ...
                for (int j = 0; j < m; j++) {
                    ...
                    final CoordinateTransformation newNedC =
                            new CoordinateTransformation(newRoll, newPitch, newYaw, FrameType.BODY_FRAME,
