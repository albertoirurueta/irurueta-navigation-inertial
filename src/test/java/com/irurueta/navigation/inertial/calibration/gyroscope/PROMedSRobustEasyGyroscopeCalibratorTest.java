...
class PROMedSRobustEasyGyroscopeCalibratorTest implements RobustEasyGyroscopeCalibratorListener {
    ...
    void testConstructor1() throws WrongSizeException {
        ...
        assertEquals(PROMedSRobustEasyGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA, calibrator.getProgressDelta(),
                0.0);
        assertEquals(PROMedSRobustEasyGyroscopeCalibrator.DEFAULT_CONFIDENCE, calibrator.getConfidence(), 0.0);
        assertEquals(PROMedSRobustEasyGyroscopeCalibrator.DEFAULT_MAX_ITERATIONS, calibrator.getMaxIterations());
        assertNull(calibrator.getInliersData());
        assertTrue(calibrator.isResultRefined());
        assertTrue(calibrator.isCovarianceKept());
        assertNull(calibrator.getQualityScores());
        assertEquals(PROMedSRobustEasyGyroscopeCalibrator.DEFAULT_STOP_THRESHOLD, calibrator.getStopThreshold(), 
                0.0);
    ...
    void testConstructor2() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustEasyGyroscopeCalibrator(sequences, bg, mg, gg);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustEasyGyroscopeCalibrator(sequences, m1, mg,
                gg));
        final var m2 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustEasyGyroscopeCalibrator(sequences, m2, mg,
                gg));
        final var m3 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustEasyGyroscopeCalibrator(sequences, bg, m3,
                gg));
        final var m4 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustEasyGyroscopeCalibrator(sequences, bg, m4,
                gg));
        final var m5 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustEasyGyroscopeCalibrator(sequences, bg, mg,
                m5));
        final var m6 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustEasyGyroscopeCalibrator(
                sequences, bg, mg, m6));
    }
    ...
    void testConstructor3() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustEasyGyroscopeCalibrator(sequences, bg, mg, gg, this);
    ...
    void testConstructor4() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustEasyGyroscopeCalibrator(sequences, bias, mg, gg);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustEasyGyroscopeCalibrator(sequences,
                new double[1], mg, gg));
        final var m1 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustEasyGyroscopeCalibrator(sequences, bias, m1,
                gg));
        final var m2 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustEasyGyroscopeCalibrator(sequences, bias, m2,
                gg));
        final var m3 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustEasyGyroscopeCalibrator(sequences, bias, mg,
                m3));
        final var m4 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustEasyGyroscopeCalibrator(sequences, bias, mg,
                m4));
    ...
    void testConstructor5() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustEasyGyroscopeCalibrator(sequences, bias, mg, gg, this);
    ...
    void testConstructor6() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustEasyGyroscopeCalibrator(sequences, bias, mg, gg, baArray, ma);
    ...
    void testConstructor8() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustEasyGyroscopeCalibrator(sequences, bg, mg, gg, ba, ma);
    ...
    void testConstructor9() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustEasyGyroscopeCalibrator(sequences, bg, mg, gg, ba, ma, this);
    ...
    void testConstructor10() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustEasyGyroscopeCalibrator(sequences, false,
                false, bg, mg, gg);
    ...
    void testConstructor18() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustEasyGyroscopeCalibrator(qualityScores);
        ...
        assertEquals(PROMedSRobustEasyGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA, calibrator.getProgressDelta(),
                0.0);
        assertEquals(PROMedSRobustEasyGyroscopeCalibrator.DEFAULT_CONFIDENCE, calibrator.getConfidence(),
                0.0);
        assertEquals(PROMedSRobustEasyGyroscopeCalibrator.DEFAULT_MAX_ITERATIONS, calibrator.getMaxIterations());
        assertNull(calibrator.getInliersData());
        assertTrue(calibrator.isResultRefined());
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustEasyGyroscopeCalibrator(new double[1]));
    }
    ...
    void testConstructor19() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustEasyGyroscopeCalibrator(qualityScores, sequences, bg, mg, gg);
        ...
        final var m1 = new Matrix(1, 1);
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustEasyGyroscopeCalibrator(qualityScores,
                sequences, m1, mg, gg));
        final var m2 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustEasyGyroscopeCalibrator(qualityScores,
                sequences, m2, mg, gg));
    ...
    void testConstructor21() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustEasyGyroscopeCalibrator(qualityScores, sequences, bias, mg, gg);
    ...
    void testConstructor23() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustEasyGyroscopeCalibrator(qualityScores, sequences, bias, mg, gg, baArray,
                ma);
    ...
    void testConstructor25() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustEasyGyroscopeCalibrator(qualityScores, sequences, bg, mg, gg, ba, ma);
    ...
    void testConstructor27() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustEasyGyroscopeCalibrator(qualityScores, sequences, false,
                false, bg, mg, gg);
    ...
    void testConstructor34() throws WrongSizeException {
        ...
        final var m6 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustEasyGyroscopeCalibrator(qualityScores,
                sequences, false, false, bg, mg, m6, ba, ma, this));
        final var m7 = new Matrix(1, 1);
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustEasyGyroscopeCalibrator(qualityScores,
    ...
    void testCalibrateCommonAxisAndGDependentCrossBiasesDisabledAndNoInlierNoise() throws WrongSizeException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var calibrator = new PROMedSRobustEasyGyroscopeCalibrator(qualityScores, sequences,
    ...
    void testCalibrateGeneralAndGDependentCrossBiasesEnabledAndNoInlierNoise() throws WrongSizeException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            for (var i = 0; i < MEASUREMENT_NUMBER; i++) {
                ...
                final var trueBeforeGravityKinematics = ECEFKinematicsEstimator
    ...
    private static void checkLocked(final PROMedSRobustEasyGyroscopeCalibrator calibrator) {
