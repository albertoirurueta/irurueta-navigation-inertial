...
class AccumulatedAngularSpeedMeasurementNoiseEstimatorTest implements 
    ...
    void testConstructor1() {
        final var estimator = new AccumulatedAngularSpeedMeasurementNoiseEstimator();
    ...
    void testConstructor2() {
        final var estimator = new AccumulatedAngularSpeedMeasurementNoiseEstimator(this);
    ...
    void testAddTriadAndReset1() throws LockedException, WrongSizeException {
        ...
        final var lastMeasurement = new AngularSpeed(0.0, AngularSpeedUnit.DEGREES_PER_SECOND);
        double value;
        var avg = 0.0;
        var v = 0.0;
