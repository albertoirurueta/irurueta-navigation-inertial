...
class RANSACRobustKnownFrameGyroscopeCalibratorTest implements RobustKnownFrameGyroscopeCalibratorListener {
    ...
    void testConstructor1() throws WrongSizeException {
        final var calibrator = new RANSACRobustKnownFrameGyroscopeCalibrator();

        // check default values
        assertEquals(RANSACRobustKnownFrameGyroscopeCalibrator.DEFAULT_THRESHOLD, calibrator.getThreshold(), 0.0);
        assertEquals(RANSACRobustKnownFrameGyroscopeCalibrator.DEFAULT_COMPUTE_AND_KEEP_INLIERS, 
                calibrator.isComputeAndKeepInliersEnabled());
        assertEquals(RANSACRobustKnownFrameGyroscopeCalibrator.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS,
    ...
    void testConstructor2() throws WrongSizeException {
        final var calibrator = new RANSACRobustKnownFrameGyroscopeCalibrator(this);
    ...
    void testConstructor3() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustKnownFrameGyroscopeCalibrator(measurements);
    ...
    void testConstructor4() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustKnownFrameGyroscopeCalibrator(measurements, this);
    ...
    void testConstructor5() throws WrongSizeException {
        final var calibrator = new RANSACRobustKnownFrameGyroscopeCalibrator(true);
    ...
    void testConstructor6() throws WrongSizeException {
        final var calibrator = new RANSACRobustKnownFrameGyroscopeCalibrator(true, this);
    ...
    void testConstructor7() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustKnownFrameGyroscopeCalibrator(measurements, true);
    ...
    void testGetSetProgressDelta() throws LockedException {
        ...
        // check default value
        assertEquals(RANSACRobustKnownFrameGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA, calibrator.getProgressDelta(),
                0.0);
    ...
    void testGetSetConfidence() throws LockedException {
        ...
        // check default value
        assertEquals(RANSACRobustKnownFrameGyroscopeCalibrator.DEFAULT_CONFIDENCE, calibrator.getConfidence(), 
                0.0);
    ...
    void testGetSetMaxIterations() throws LockedException {
        ...
        // check default value
        assertEquals(RANSACRobustKnownFrameGyroscopeCalibrator.DEFAULT_MAX_ITERATIONS, calibrator.getMaxIterations());
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        ...
        // check default value
        assertEquals(RANSACRobustKnownFrameGyroscopeCalibrator.MINIMUM_MEASUREMENTS, 
    ...
    void testCalibrateGeneralNoNoiseInlier() throws WrongSizeException, InvalidSourceAndDestinationFrameTypeException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var calibrator = new RANSACRobustKnownFrameGyroscopeCalibrator(measurements, false, this);
    ...
    void testCalibrateGeneralWithInlierNoise() throws WrongSizeException, InvalidSourceAndDestinationFrameTypeException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var calibrator = new RANSACRobustKnownFrameGyroscopeCalibrator(measurements, false,
                    this);
    ...
    private static void assertEstimatedResult(
            ...
            final RANSACRobustKnownFrameGyroscopeCalibrator calibrator, final boolean checkCovariance)
    ...
    private static void assertCovariance(final RANSACRobustKnownFrameGyroscopeCalibrator calibrator) {
