...
class PROMedSRobustKnownGravityNormAccelerometerCalibratorTest implements 
    ...
    void testConstructor1() throws WrongSizeException {
        ...
        assertEquals(PROMedSRobustKnownGravityNormAccelerometerCalibrator.DEFAULT_STOP_THRESHOLD, 
    ...
    void testConstructor2() throws WrongSizeException {
        final var calibrator = new PROMedSRobustKnownGravityNormAccelerometerCalibrator(this);
    ...
    void testConstructor3() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownGravityNormAccelerometerCalibrator(measurements);
    ...
    void testConstructor4() throws WrongSizeException {
        final var calibrator = new PROMedSRobustKnownGravityNormAccelerometerCalibrator(true);
    ...
    void testConstructor5() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownGravityNormAccelerometerCalibrator(bias);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustKnownGravityNormAccelerometerCalibrator(
                new double[1]));
    }
    ...
    void testConstructor6() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownGravityNormAccelerometerCalibrator(ba);
    ...
    void testConstructor7() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownGravityNormAccelerometerCalibrator(ba, ma);
    ...
    void testConstructor8() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownGravityNormAccelerometerCalibrator(gravityNorm);
    ...
    void testConstructor9() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownGravityNormAccelerometerCalibrator(gravityNorm, measurements);
    ...
    void testConstructor17() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownGravityNormAccelerometerCalibrator(gravityNorm, measurements, ba);
    ...
    void testConstructor31() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownGravityNormAccelerometerCalibrator(gravityNorm, measurements, bias,
                this);
    ...
    void testConstructor42() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownGravityNormAccelerometerCalibrator(qualityScores, gravityNorm,
                measurements);
    ...
    void testGetSetStopThreshold() throws LockedException {
        ...
        // check
        assertEquals(0.1, calibrator.getStopThreshold(), 0.0);
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        ...
        // check default value
        assertEquals(PROMedSRobustKnownGravityNormAccelerometerCalibrator.MINIMUM_MEASUREMENTS_GENERAL,
                calibrator.getPreliminarySubsetSize());
    ...
    void testCalibrateGeneralNoNoiseInlier() throws WrongSizeException, InvalidSourceAndDestinationFrameTypeException, 
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            for (var i = 0; i < MEASUREMENT_NUMBER; i++) {
                ...
                final var nedC = new CoordinateTransformation(roll, pitch, yaw, 
            ...
            final var calibrator = new PROMedSRobustKnownGravityNormAccelerometerCalibrator(qualityScores, 
    ...
    private void checkLocked(final PROMedSRobustKnownGravityNormAccelerometerCalibrator calibrator) {
        ...
        assertThrows(LockedException.class, () -> calibrator.setInitialBias(0.0, 0.0, 0.0));
        assertThrows(LockedException.class, () -> calibrator.setInitialBias(null, null, null));
    ...
    private static void assertEstimatedResult(
            final Matrix ba, final Matrix ma, final PROMedSRobustKnownGravityNormAccelerometerCalibrator calibrator,
    ...
    private static void assertCovariance(final PROMedSRobustKnownGravityNormAccelerometerCalibrator calibrator) {
