...
class RANSACRobustKnownHardIronPositionAndInstantMagnetometerCalibratorTest implements
    ...
    void testConstructor1() throws WrongSizeException {
        final var calibrator = new RANSACRobustKnownHardIronPositionAndInstantMagnetometerCalibrator();

        // check default values
        assertEquals(RANSACRobustKnownHardIronPositionAndInstantMagnetometerCalibrator.DEFAULT_THRESHOLD,
                calibrator.getThreshold(), 0.0);
        assertEquals(RANSACRobustKnownHardIronPositionAndInstantMagnetometerCalibrator.DEFAULT_COMPUTE_AND_KEEP_INLIERS,
    ...
    void testConstructor2() throws WrongSizeException {
        final var calibrator = new RANSACRobustKnownHardIronPositionAndInstantMagnetometerCalibrator(this);
    ...
    void testConstructor3() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustKnownHardIronPositionAndInstantMagnetometerCalibrator(measurements);
    ...
    void testConstructor5() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustKnownHardIronPositionAndInstantMagnetometerCalibrator(magneticModel);
    ...
    void testConstructor6() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustKnownHardIronPositionAndInstantMagnetometerCalibrator(hardIron);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACRobustKnownHardIronPositionAndInstantMagnetometerCalibrator(new double[1]));
    }
    ...
    void testConstructor7() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustKnownHardIronPositionAndInstantMagnetometerCalibrator(bm);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACRobustKnownHardIronPositionAndInstantMagnetometerCalibrator(m1));
        final var m2 = new Matrix(1, 1);
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACRobustKnownHardIronPositionAndInstantMagnetometerCalibrator(m2));
    }
    ...
    void testConstructor8() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustKnownHardIronPositionAndInstantMagnetometerCalibrator(bm, mm);
        ...
        final var m1 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACRobustKnownHardIronPositionAndInstantMagnetometerCalibrator(m1, mm));
        final var m2 = new Matrix(1, 1);
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACRobustKnownHardIronPositionAndInstantMagnetometerCalibrator(m2, mm));
        final var m3 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACRobustKnownHardIronPositionAndInstantMagnetometerCalibrator(bm, m3));
        final var m4 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACRobustKnownHardIronPositionAndInstantMagnetometerCalibrator(bm, m4));
    }
    ...
    void testConstructor9() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustKnownHardIronPositionAndInstantMagnetometerCalibrator(nedPosition);
    ...
    void testConstructor14() throws WrongSizeException {
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACRobustKnownHardIronPositionAndInstantMagnetometerCalibrator(nedPosition, measurements,
                        new double[1]));
    }
    ...
    void testConstructor15() throws WrongSizeException {
        ...
        assertEquals(RANSACRobustKnownHardIronPositionAndInstantMagnetometerCalibrator.DEFAULT_COMPUTE_AND_KEEP_INLIERS,
                calibrator.isComputeAndKeepInliersEnabled());
        assertEquals(RANSACRobustKnownHardIronPositionAndInstantMagnetometerCalibrator.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS,
                calibrator.isComputeAndKeepResiduals());
        assertEquals(bmx, calibrator.getHardIronX(), 0.0);
        assertEquals(bmy,calibrator.getHardIronY(), 0.0);
        assertEquals(bmz, calibrator.getHardIronZ(), 0.0);
    ...
    void testConstructor26() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustKnownHardIronPositionAndInstantMagnetometerCalibrator(ecefPosition);
    ...
    void testConstructor31() throws WrongSizeException {
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new RANSACRobustKnownHardIronPositionAndInstantMagnetometerCalibrator(ecefPosition, measurements,
                        new double[1]));
    }
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        ...
        // check default value
        assertEquals(RANSACRobustKnownHardIronPositionAndInstantMagnetometerCalibrator.MINIMUM_MEASUREMENTS_GENERAL,
    ...
    void testCalibrateGeneralNoNoiseInlier() throws IOException, LockedException, CalibrationException, 
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var calibrator = new RANSACRobustKnownHardIronPositionAndInstantMagnetometerCalibrator(position,
    ...
    @Test
    void testCalibrateCommonAxisNoNoiseInlier() throws IOException, LockedException, NotReadyException {
    ...
    private static void assertEstimatedResult(
            final Matrix mm, final RANSACRobustKnownHardIronPositionAndInstantMagnetometerCalibrator calibrator) {
