...
class LMedSRobustKnownFrameMagnetometerCalibratorTest implements RobustKnownFrameMagnetometerCalibratorListener {
    ...
    void testConstructor1() throws WrongSizeException {
        final var calibrator = new LMedSRobustKnownFrameMagnetometerCalibrator();
    ...
    void testConstructor2() throws WrongSizeException {
        final var calibrator = new LMedSRobustKnownFrameMagnetometerCalibrator(this);
        ...
        assertEquals(RobustKnownFrameMagnetometerCalibrator.DEFAULT_PROGRESS_DELTA, calibrator.getProgressDelta(),
                0.0f);
        assertEquals(RobustKnownFrameMagnetometerCalibrator.DEFAULT_CONFIDENCE, calibrator.getConfidence(), 0.0);
        assertEquals(RobustKnownFrameMagnetometerCalibrator.DEFAULT_MAX_ITERATIONS,
    ...
    void testConstructor3() throws WrongSizeException {
        ...
        final var calibrator = new LMedSRobustKnownFrameMagnetometerCalibrator(measurements);
    ...
    void testConstructor4() throws WrongSizeException {
        ...
        final var calibrator = new LMedSRobustKnownFrameMagnetometerCalibrator(measurements, this);
    ...
    void testConstructor5() throws WrongSizeException {
        final var calibrator = new LMedSRobustKnownFrameMagnetometerCalibrator(true);
    ...
    void testConstructor6() throws WrongSizeException {
        final var calibrator = new LMedSRobustKnownFrameMagnetometerCalibrator(true, this);
    ...
    void testConstructor7() throws WrongSizeException {
        ...
        final var calibrator = new LMedSRobustKnownFrameMagnetometerCalibrator(measurements, true);
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        ...
        // check default value
        assertEquals(LMedSRobustKnownFrameMagnetometerCalibrator.MINIMUM_MEASUREMENTS, 
                calibrator.getPreliminarySubsetSize());
    ...
    void testCalibrateGeneralNoNoiseInlier() throws IOException, InvalidSourceAndDestinationFrameTypeException,
        ...
        final var calibrator = new LMedSRobustKnownFrameMagnetometerCalibrator(measurements, false,
                this);
    ...
    private void checkLocked(final LMedSRobustKnownFrameMagnetometerCalibrator calibrator) {
    ...
    private static void assertEstimatedResult(
            final Matrix hardIron, final Matrix mm, final LMedSRobustKnownFrameMagnetometerCalibrator calibrator,
    ...
    private static void assertCovariance(final LMedSRobustKnownFrameMagnetometerCalibrator calibrator) {
