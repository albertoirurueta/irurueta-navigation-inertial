...
public class LMedSRobustKnownFrameMagnetometerCalibratorTest implements RobustKnownFrameMagnetometerCalibratorListener {
    ...
    public void testConstructor2() throws WrongSizeException {
        final LMedSRobustKnownFrameMagnetometerCalibrator calibrator = new LMedSRobustKnownFrameMagnetometerCalibrator(
                this);
    ...
    public void testConstructor3() throws WrongSizeException {
        ...
        assertEquals(LMedSRobustKnownFrameMagnetometerCalibrator.DEFAULT_STOP_THRESHOLD,
    ...
    public void testCalibrateGeneralWithInlierNoise() throws IOException, InvalidSourceAndDestinationFrameTypeException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final LMedSRobustKnownFrameMagnetometerCalibrator calibrator =
                    new LMedSRobustKnownFrameMagnetometerCalibrator(measurements, false, this);
    ...
    public void testCalibrateCommonAxisWithInlierNoise() throws IOException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final LMedSRobustKnownFrameMagnetometerCalibrator calibrator =
                    new LMedSRobustKnownFrameMagnetometerCalibrator(measurements, true, this);
            calibrator.setStopThreshold(LARGE_THRESHOLD);
