...
class PROSACRobustKnownFrameGyroscopeCalibratorTest implements RobustKnownFrameGyroscopeCalibratorListener {
    ...
    void testConstructor1() throws WrongSizeException {
        final var calibrator = new PROSACRobustKnownFrameGyroscopeCalibrator();

        // check default values
        assertEquals(PROSACRobustKnownFrameGyroscopeCalibrator.DEFAULT_THRESHOLD, calibrator.getThreshold(), 0.0);
        assertEquals(PROSACRobustKnownFrameGyroscopeCalibrator.DEFAULT_COMPUTE_AND_KEEP_INLIERS,
                calibrator.isComputeAndKeepInliersEnabled());
        assertEquals(PROSACRobustKnownFrameGyroscopeCalibrator.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS,
    ...
    void testConstructor2() throws WrongSizeException {
        final var calibrator = new PROSACRobustKnownFrameGyroscopeCalibrator(this);
    ...
    void testConstructor3() throws WrongSizeException {
        ...
        final var calibrator = new PROSACRobustKnownFrameGyroscopeCalibrator(measurements);
    ...
    void testConstructor4() throws WrongSizeException {
        ...
        final var calibrator = new PROSACRobustKnownFrameGyroscopeCalibrator(measurements, this);
    ...
    void testConstructor5() throws WrongSizeException {
        final var calibrator = new PROSACRobustKnownFrameGyroscopeCalibrator(true);
    ...
    void testConstructor6() throws WrongSizeException {
        final var calibrator = new PROSACRobustKnownFrameGyroscopeCalibrator(true, this);
    ...
    void testConstructor7() throws WrongSizeException {
        ...
        final var calibrator = new PROSACRobustKnownFrameGyroscopeCalibrator(measurements, true);
    ...
    void testConstructor9() throws WrongSizeException {
        final var qualityScores = new double[PROSACRobustKnownFrameGyroscopeCalibrator.MINIMUM_MEASUREMENTS];
        final var calibrator = new PROSACRobustKnownFrameGyroscopeCalibrator(qualityScores);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownFrameGyroscopeCalibrator(
                new double[1]));
    }
    ...
    void testConstructor10() throws WrongSizeException {
        final var qualityScores = new double[PROSACRobustKnownFrameGyroscopeCalibrator.MINIMUM_MEASUREMENTS];
        final var calibrator = new PROSACRobustKnownFrameGyroscopeCalibrator(qualityScores, this);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustKnownFrameGyroscopeCalibrator(new double[1],
                this));
    }
    ...
    void testConstructor11() throws WrongSizeException {
        ...
        PROSACRobustKnownFrameGyroscopeCalibrator calibrator = new PROSACRobustKnownFrameGyroscopeCalibrator(
    ...
    void testConstructor12() throws WrongSizeException {
        ...
        final var calibrator = new PROSACRobustKnownFrameGyroscopeCalibrator(qualityScores, measurements, this);
    ...
    void testConstructor13() throws WrongSizeException {
        final var qualityScores = new double[PROSACRobustKnownFrameGyroscopeCalibrator.MINIMUM_MEASUREMENTS];
        final var calibrator = new PROSACRobustKnownFrameGyroscopeCalibrator(qualityScores, true);
    ...
    void testConstructor15() throws WrongSizeException {
        ...
        final var calibrator = new PROSACRobustKnownFrameGyroscopeCalibrator(qualityScores, measurements, 
                true);
    ...
    void testGetSetProgressDelta() throws LockedException {
        ...
        // check default value
        assertEquals(PROSACRobustKnownFrameGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA, calibrator.getProgressDelta(),
                0.0);
    ...
    void testGetSetConfidence() throws LockedException {
        ...
        // check default value
        assertEquals(PROSACRobustKnownFrameGyroscopeCalibrator.DEFAULT_CONFIDENCE, calibrator.getConfidence(),
                0.0);
    ...
    void testGetSetMaxIterations() throws LockedException {
        ...
        // check default value
        assertEquals(PROSACRobustKnownFrameGyroscopeCalibrator.DEFAULT_MAX_ITERATIONS, calibrator.getMaxIterations());
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        ...
        // check default value
        assertEquals(PROSACRobustKnownFrameGyroscopeCalibrator.MINIMUM_MEASUREMENTS, calibrator.getPreliminarySubsetSize());
    ...
    @Test
    void testCalibrateGeneralNoRefinement() throws WrongSizeException,
            InvalidSourceAndDestinationFrameTypeException, LockedException, CalibrationException, NotReadyException {
    ...
    private static void assertEstimatedResult(
            ...
            final PROSACRobustKnownFrameGyroscopeCalibrator calibrator, final boolean checkCovariance)
    ...
    private static void assertCovariance(final PROSACRobustKnownFrameGyroscopeCalibrator calibrator) {
