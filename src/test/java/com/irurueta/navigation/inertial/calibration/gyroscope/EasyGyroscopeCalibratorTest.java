...
public class EasyGyroscopeCalibratorTest implements EasyGyroscopeCalibratorListener {
    ...
    public void testConstructor2() throws WrongSizeException {
        ...
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, m1, mg, gg));
        final var m2 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, m2, mg, gg));
        final var m3 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, bg, m3, gg));
        final var m4 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, bg, m4, gg));
        final var m5 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, bg, mg, m5));
        final var m6 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, bg, mg, m6));
    }
    ...
    public void testConstructor3() throws WrongSizeException {
        ...
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, bg, mg, m5,
                this));
        final var m6 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, bg, mg, m6, this));
    }
    ...
    public void testConstructor4() throws WrongSizeException {
        ...
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, bgArray, m2, gg));
        final var m3 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, bgArray, mg, m3));
        final var m4 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, bgArray, mg, m4));
    }
    ...
    public void testConstructor6() throws WrongSizeException {
        ...
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, bgArray, mg, m4,
                bgArray, ma));
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, bgArray, mg, gg,
                new double[1], ma));
        final var m5 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, bgArray, mg, gg,
                baArray, m5));
    ...
    public void testConstructor8() throws WrongSizeException {
        ...
        // Force IllegalArgumentException
        final var m1 = new Matrix(1, 1);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, m1, mg, gg, ba, ma));
        final var m2 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, m2, mg, gg, ba, ma));
        final var m3 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, bg, m3, gg, ba, ma));
        final var m4 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, bg, m4, gg, ba, ma));
        final var m5 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, bg, mg, m5, ba, ma));
        final var m6 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, bg, mg, m6, ba, ma));
        final var m7 = new Matrix(1, 1);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, bg, mg, gg, m7, ma));
        final var m8 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, bg, mg, gg, m8, ma));
        final var m9 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, bg, mg, gg, ba, m9));
        final var m10 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, bg, mg, gg, ba, m10));
    }
    ...
    public void testConstructor10() throws WrongSizeException {
        ...
        // Force IllegalArgumentException
        final var m1 = new Matrix(1, 1);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, false,
                false, m1, mg, gg));
        final var m2 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, false,
                false, m2, mg, gg));
    ...
    public void testConstructor13() throws WrongSizeException {
        ...
        final var m1 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, false,
                false, bgArray, m1, gg, this));
        final var m2 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, false,
                false, bgArray, m2, gg, this));
        final var m3 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, false,
                false, bgArray, mg, m3, this));
        final var m4 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, false,
                false, bgArray, mg, m4, this));
    }
    ...
    public void testConstructor14() throws WrongSizeException {
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, false,
                false, new double[1], mg, gg, baArray, ma));
        final var m1 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, false,
                false, bgArray, m1, gg, bgArray, ma));
        final var m2 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, false,
                false, bgArray, m2, gg, bgArray, ma));
        final var m3 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, false,
                false, bgArray, mg, m3, bgArray, ma));
        final var m4 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, false,
                false, bgArray, mg, m4, bgArray, ma));
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, false,
                false, bgArray, mg, gg, new double[1], ma));
        final var m5 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, false,
                false, bgArray, mg, gg, baArray, m5));
        final var m6 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, false,
                false, bgArray, mg, gg, baArray, m6));
    }
    ...
    public void testConstructor15() throws WrongSizeException {
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, false,
                false, new double[1], mg, gg, baArray, ma, this));
        final var m1 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, false,
                false, bgArray, m1, gg, bgArray, ma, this));
        final var m2 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, false,
                false, bgArray, m2, gg, bgArray, ma, this));
        final var m3 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, false,
                false, bgArray, mg, m3, bgArray, ma, this));
        final var m4 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, false,
                false, bgArray, mg, m4, bgArray, ma, this));
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, false,
                false, bgArray, mg, gg, new double[1], ma, this));
        final var m5 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, false,
                false, bgArray, mg, gg, baArray, m5, this));
        final var m6 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new EasyGyroscopeCalibrator(sequences, false,
                false, bgArray, mg, gg, baArray, m6, this));
    }
    ...
    private static void checkLocked(final EasyGyroscopeCalibrator calibrator) {
        ...
        assertThrows(LockedException.class, () -> calibrator.setInitialBias(0.0, 0.0,
                0.0));
    ...
    private static void assertCovariance(final EasyGyroscopeCalibrator calibrator) {
