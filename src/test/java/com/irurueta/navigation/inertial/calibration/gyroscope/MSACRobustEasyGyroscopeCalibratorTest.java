...
class MSACRobustEasyGyroscopeCalibratorTest implements RobustEasyGyroscopeCalibratorListener {
    ...
    void testConstructor1() throws WrongSizeException {
        final var calibrator = new MSACRobustEasyGyroscopeCalibrator();
        ...
        assertEquals(MSACRobustEasyGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA, calibrator.getProgressDelta(), 
                0.0);
        assertEquals(MSACRobustEasyGyroscopeCalibrator.DEFAULT_CONFIDENCE, calibrator.getConfidence(), 0.0);
        assertEquals(MSACRobustEasyGyroscopeCalibrator.DEFAULT_MAX_ITERATIONS, calibrator.getMaxIterations());
        assertNull(calibrator.getInliersData());
        assertTrue(calibrator.isResultRefined());
        assertTrue(calibrator.isCovarianceKept());
        assertNull(calibrator.getQualityScores());
        assertEquals(MSACRobustEasyGyroscopeCalibrator.DEFAULT_THRESHOLD, calibrator.getThreshold(), 0.0);
    ...
    void testConstructor2() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustEasyGyroscopeCalibrator(sequences, bg, mg, gg);
        ...
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustEasyGyroscopeCalibrator(sequences, m1, mg,
                gg));
        final var m2 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustEasyGyroscopeCalibrator(sequences, m2, mg,
                gg));
        final var m3 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustEasyGyroscopeCalibrator(sequences, bg, m3,
                gg));
        final var m4 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustEasyGyroscopeCalibrator(sequences, bg, m4,
                gg));
        final var m5 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustEasyGyroscopeCalibrator(sequences, bg, mg,
                m5));
    ...
    void testConstructor3() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustEasyGyroscopeCalibrator(sequences, bg, mg, gg, this);
        ...
        final var m1 = new Matrix(1, 1);
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustEasyGyroscopeCalibrator(sequences, m1, mg, gg,
                this));
        final var m2 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustEasyGyroscopeCalibrator(sequences, m2, mg, gg,
                this));
        final var m3 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustEasyGyroscopeCalibrator(sequences, bg, m3, gg,
                this));
        final var m4 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustEasyGyroscopeCalibrator(sequences, bg, m4, gg,
                this));
        final var m5 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustEasyGyroscopeCalibrator(sequences, bg, mg, m5,
                this));
        final var m6 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustEasyGyroscopeCalibrator(sequences, bg, mg, m6,
                this));
    }
    ...
    void testConstructor4() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustEasyGyroscopeCalibrator(sequences, bias, mg, gg);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustEasyGyroscopeCalibrator(sequences,
                new double[1], mg, gg));
        final var m1 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustEasyGyroscopeCalibrator(sequences, bias,
                m1, gg));
        final var m2 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustEasyGyroscopeCalibrator(sequences, bias,
                m2, gg));
        final var m3 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustEasyGyroscopeCalibrator(sequences, bias, mg,
                m3));
        final var m4 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustEasyGyroscopeCalibrator(sequences, bias, mg,
                m4));
    ...
    void testConstructor5() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustEasyGyroscopeCalibrator(sequences, bias, mg, gg, this);
        ...
        final var m1 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustEasyGyroscopeCalibrator(sequences, bias, m1,
                gg, this));
        final var m2 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustEasyGyroscopeCalibrator(sequences, bias, m2,
                gg, this));
        final var m3 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustEasyGyroscopeCalibrator(sequences, bias, mg,
                m3, this));
    ...
    void testConstructor6() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustEasyGyroscopeCalibrator(sequences, bias, mg, gg, baArray, ma);
    ...
    void testConstructor7() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustEasyGyroscopeCalibrator(sequences, bias, mg, gg, baArray, ma, this);
    ...
    void testConstructor8() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustEasyGyroscopeCalibrator(sequences, bg, mg, gg, ba, ma);
        ...
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustEasyGyroscopeCalibrator(sequences, bg, mg, gg,
                m7, ma));
    ...
    void testConstructor9() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustEasyGyroscopeCalibrator(sequences, bg, mg, gg, ba, ma, this);
    ...
    void testConstructor10() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustEasyGyroscopeCalibrator(sequences, false,
                false, bg, mg, gg);
    ...
    void testGetSetInitialBiasAsTriad() throws LockedException {
        ...
        final var triad3 = new AngularSpeedTriad(AngularSpeedUnit.RADIANS_PER_SECOND, initialBiasX, initialBiasY,
                initialBiasZ);
    ...
    void testCalibrateCommonAxisAndGDependentCrossBiasesDisabledAndNoInlierNoise() throws WrongSizeException,
        ...
        for (var t = 0; t < TIMES; t++) {
                ...
                for (var j = 0; j < m; j++) {
                    ...
                    if (sequenceCanHaveOutliers && randomizer.nextInt(0, 100) < OUTLIER_PERCENTAGE) {
                        ...
                        measuredKinematics = BodyKinematicsGenerator.generate(TIME_INTERVAL_SECONDS,
                                trueKinematics, errorsOutlier, random);
                    } else {
                        // inlier
            ...
            final var calibrator = new MSACRobustEasyGyroscopeCalibrator(sequences, true,
                    false, bg, mg, gg, ba, ma, this);
    ...
    void testCalibrateCommonAxisAndGDependentCrossBiasesDisabledWithInlierNoise() throws WrongSizeException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var calibrator = new MSACRobustEasyGyroscopeCalibrator(sequences,
    ...
    private static void checkLocked(final MSACRobustEasyGyroscopeCalibrator calibrator) {
    ...
    private static void assertEstimatedResult(final Matrix bg, final Matrix mg, final Matrix gg,
            final RobustEasyGyroscopeCalibrator calibrator) throws WrongSizeException {
