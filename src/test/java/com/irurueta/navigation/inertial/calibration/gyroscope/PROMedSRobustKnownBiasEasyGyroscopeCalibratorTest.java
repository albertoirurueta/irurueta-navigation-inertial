...
class PROMedSRobustKnownBiasEasyGyroscopeCalibratorTest implements RobustKnownBiasEasyGyroscopeCalibratorListener {
    ...
    void testConstructor1() throws WrongSizeException {
        final var calibrator = new PROMedSRobustKnownBiasEasyGyroscopeCalibrator();
    ...
    void testConstructor2() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownBiasEasyGyroscopeCalibrator(sequences, bg, mg, gg);
    ...
    void testConstructor3() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownBiasEasyGyroscopeCalibrator(sequences, bg, mg, gg, this);
    ...
    void testConstructor4() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownBiasEasyGyroscopeCalibrator(sequences, bias, mg, gg);
    ...
    void testConstructor5() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownBiasEasyGyroscopeCalibrator(sequences, bias, mg, gg, this);
    ...
    void testConstructor6() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownBiasEasyGyroscopeCalibrator(sequences, bias, mg, gg, baArray, ma);
    ...
    void testConstructor8() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownBiasEasyGyroscopeCalibrator(sequences, bg, mg, gg, ba, ma);
    ...
    void testConstructor10() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownBiasEasyGyroscopeCalibrator(sequences, false,
                false, bg, mg, gg);
    ...
    void testConstructor18() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownBiasEasyGyroscopeCalibrator(qualityScores);
    ...
    void testConstructor19() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownBiasEasyGyroscopeCalibrator(qualityScores, sequences, bg, mg, gg);
    ...
    void testConstructor21() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownBiasEasyGyroscopeCalibrator(qualityScores, sequences, bias, mg, 
                gg);
    ...
    void testConstructor22() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownBiasEasyGyroscopeCalibrator(qualityScores, sequences, bias, mg, gg,
                this);
    ...
    void testConstructor27() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownBiasEasyGyroscopeCalibrator(qualityScores, sequences, 
    ...
    void testCalibrateCommonAxisAndGDependentCrossBiasesEnabledAndNoInlierNoise() throws WrongSizeException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            for (var i = 0; i < MEASUREMENT_NUMBER; i++) {
                ...
                final var trueSequence =
                        new BodyKinematicsSequence<StandardDeviationTimedBodyKinematics>();
                final var sequence = new BodyKinematicsSequence<StandardDeviationTimedBodyKinematics>();
                sequence.setBeforeMeanSpecificForceCoordinates(beforeMeanFx, beforeMeanFy, beforeMeanFz);
