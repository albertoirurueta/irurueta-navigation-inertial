...
public class LMedSRobustKnownMagneticFluxDensityNormMagnetometerCalibratorTest implements
    ...
    public void testConstructor1() throws WrongSizeException {
        ...
        assertEquals(calibrator.getStopThreshold(),
                LMedSRobustKnownMagneticFluxDensityNormMagnetometerCalibrator.DEFAULT_STOP_THRESHOLD, 0.0);
        ...
        assertEquals(calibrator.getProgressDelta(),
                LMedSRobustKnownMagneticFluxDensityNormMagnetometerCalibrator.DEFAULT_PROGRESS_DELTA,
                0.0f);
        assertEquals(calibrator.getConfidence(),
                LMedSRobustKnownMagneticFluxDensityNormMagnetometerCalibrator.DEFAULT_CONFIDENCE,
                0.0);
        assertEquals(calibrator.getMaxIterations(),
                LMedSRobustKnownMagneticFluxDensityNormMagnetometerCalibrator.DEFAULT_MAX_ITERATIONS);
    ...
    public void testConstructor5() throws WrongSizeException {
        ...
        LMedSRobustKnownMagneticFluxDensityNormMagnetometerCalibrator calibrator =
                new LMedSRobustKnownMagneticFluxDensityNormMagnetometerCalibrator(
                        hardIron);
        ...
        calibrator = null;
        try {
            calibrator = new LMedSRobustKnownMagneticFluxDensityNormMagnetometerCalibrator(
                    new double[1]);
    ...
    public void testConstructor23() throws WrongSizeException, IOException {
        ...
        calibrator = null;
        try {
            calibrator = new LMedSRobustKnownMagneticFluxDensityNormMagnetometerCalibrator(-1.0);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(calibrator);
    ...
    public void testGetSetStopThreshold() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getStopThreshold(),
                LMedSRobustKnownMagneticFluxDensityNormMagnetometerCalibrator.DEFAULT_STOP_THRESHOLD,
                0.0);
    ...
    public void testGetSetPreliminarySubsetSize() throws LockedException {
        ...
        assertEquals(calibrator.getPreliminarySubsetSize(),
                LMedSRobustKnownMagneticFluxDensityNormMagnetometerCalibrator.MINIMUM_MEASUREMENTS_GENERAL);
