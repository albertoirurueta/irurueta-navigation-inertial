...
class RungeKuttaQuaternionStepIntegratorTest {
    ...
    void integrate_whenOneStep_computesExpectedResult() throws RotationException {
        ...
        final var integrator = new RungeKuttaQuaternionStepIntegrator();
    ...
    void integrate_whenMultipleSteps_computesExpectedResult() throws RotationException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            Logger.getLogger(RungeKuttaQuaternionStepIntegratorTest.class.getName()).log(Level.INFO, 
