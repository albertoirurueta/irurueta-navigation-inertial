...
class RANSACRobustEasyGyroscopeCalibratorTest implements RobustEasyGyroscopeCalibratorListener {
    ...
    void testConstructor1() throws WrongSizeException {
        final var calibrator = new RANSACRobustEasyGyroscopeCalibrator();
        ...
        assertEquals(RANSACRobustEasyGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA, calibrator.getProgressDelta(), 
                0.0);
        assertEquals(RANSACRobustEasyGyroscopeCalibrator.DEFAULT_CONFIDENCE, calibrator.getConfidence(), 0.0);
        assertEquals(RANSACRobustEasyGyroscopeCalibrator.DEFAULT_MAX_ITERATIONS, calibrator.getMaxIterations());
        assertNull(calibrator.getInliersData());
        assertTrue(calibrator.isResultRefined());
        assertTrue(calibrator.isCovarianceKept());
        assertNull(calibrator.getQualityScores());
        assertEquals(RANSACRobustEasyGyroscopeCalibrator.DEFAULT_THRESHOLD, calibrator.getThreshold(), 0.0);
    ...
    void testConstructor2() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustEasyGyroscopeCalibrator(sequences, bg, mg, gg);
        ...
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustEasyGyroscopeCalibrator(sequences, m1, mg,
                gg));
        final var m2 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustEasyGyroscopeCalibrator(sequences, m2, mg,
                gg));
        final var m3 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustEasyGyroscopeCalibrator(sequences, bg, m3,
                gg));
        final var m4 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustEasyGyroscopeCalibrator(sequences, bg, m4,
                gg));
        final var m5 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustEasyGyroscopeCalibrator(sequences, bg, mg,
                m5));
    ...
    void testConstructor3() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustEasyGyroscopeCalibrator(sequences, bg, mg, gg, this);
    ...
    void testConstructor4() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustEasyGyroscopeCalibrator(sequences, bias, mg, gg);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustEasyGyroscopeCalibrator(sequences,
                new double[1], mg, gg));
        final var m1 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustEasyGyroscopeCalibrator(sequences, bias, m1,
                gg));
        final var m2 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustEasyGyroscopeCalibrator(sequences, bias, m2,
                gg));
        final var m3 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustEasyGyroscopeCalibrator(sequences, bias, mg,
                m3));
        final var m4 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustEasyGyroscopeCalibrator(sequences, bias, mg,
                m4));
    ...
    void testConstructor5() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustEasyGyroscopeCalibrator(sequences, bias, mg, gg, this);
    ...
    void testConstructor6() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustEasyGyroscopeCalibrator(sequences, bias, mg, gg, baArray, ma);
    ...
    void testConstructor8() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustEasyGyroscopeCalibrator(sequences, bg, mg, gg, ba, ma);
    ...
    void testConstructor9() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustEasyGyroscopeCalibrator(sequences, bg, mg, gg, ba, ma, this);
    ...
    void testConstructor10() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustEasyGyroscopeCalibrator(sequences, false,
                false, bg, mg, gg);
    ...
    void testCalibrateCommonAxisAndGDependentCrossBiasesDisabledAndNoInlierNoise() throws WrongSizeException, 
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var calibrator = new RANSACRobustEasyGyroscopeCalibrator(sequences, true,
                    false, bg, mg, gg, ba, ma, this);
    ...
    private static void checkLocked(final RANSACRobustEasyGyroscopeCalibrator calibrator) {
