...
public class RANSACRobustEasyGyroscopeCalibratorTest implements RobustEasyGyroscopeCalibratorListener {
    ...
    public void testConstructor1() throws WrongSizeException {
        final RANSACRobustEasyGyroscopeCalibrator calibrator = new RANSACRobustEasyGyroscopeCalibrator();
        ...
        assertEquals(RANSACRobustEasyGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA, calibrator.getProgressDelta(), 0.0);
    ...
    public void testConstructor2() throws WrongSizeException {
        ...
        final RANSACRobustEasyGyroscopeCalibrator calibrator = new RANSACRobustEasyGyroscopeCalibrator(sequences,
                bg, mg, gg);
        ...
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustEasyGyroscopeCalibrator(
                sequences, m1, mg, gg));
    ...
    public void testConstructor4() throws WrongSizeException {
        ...
        final RANSACRobustEasyGyroscopeCalibrator calibrator = new RANSACRobustEasyGyroscopeCalibrator(sequences, bias,
                mg, gg);
    ...
    public void testConstructor8() throws WrongSizeException {
        ...
        final RANSACRobustEasyGyroscopeCalibrator calibrator = new RANSACRobustEasyGyroscopeCalibrator(sequences, bg,
                mg, gg, ba, ma);
    ...
    public void testCalibrateCommonAxisAndGDependentCrossBiasesDisabledAndNoInlierNoise()
            throws WrongSizeException, InvalidRotationMatrixException, InvalidSourceAndDestinationFrameTypeException,
            LockedException, NotReadyException, RotationException {
