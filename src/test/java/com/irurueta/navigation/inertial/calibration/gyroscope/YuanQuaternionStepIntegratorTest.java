...
class YuanQuaternionStepIntegratorTest {
    ...
    void integrate_whenOneStep_computesExpectedResult() throws RotationException {
        ...
        final var integrator = new YuanQuaternionStepIntegrator();
        final var result1 = new Quaternion();
        final var result2 = new Quaternion();
        YuanQuaternionStepIntegrator.integrationStep(initialAttitude, wx, wy, wz, wx, wy, wz, TIME_INTERVAL, result1);
    ...
    void integrate_whenMultipleSteps_computesExpectedResult() throws RotationException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            for (var i = 0; i < NUM_SAMPLES; i++) {
                YuanQuaternionStepIntegrator.integrationStep(result1, wx, wy, wz, wx, wy, wz, TIME_INTERVAL, result1);
    ...
    void compareErrors_whenNoNoise_haveExpectedRelativeAccuracy() throws RotationException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var resultEulerAngles = result3.toEulerAngles();
            final var resultMidPointEulerAngles = result4.toEulerAngles();
            final var resultRungeKuttaEulerAngles = result5.toEulerAngles();
            ...
            Logger.getLogger(YuanQuaternionStepIntegratorTest.class.getName()).log(Level.INFO,
