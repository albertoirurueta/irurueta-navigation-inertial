...
class MSACRobustKnownBiasAndFrameGyroscopeCalibratorTest
    ...
    void testConstructor1() throws WrongSizeException {
        final var calibrator = new MSACRobustKnownBiasAndFrameGyroscopeCalibrator();

        // check default value
        assertEquals(MSACRobustKnownBiasAndFrameGyroscopeCalibrator.DEFAULT_THRESHOLD, calibrator.getThreshold(),
                0.0);
    ...
    void testConstructor2() throws WrongSizeException {
        final var calibrator = new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(this);
    ...
    void testConstructor3() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(measurements);

        // check default value
        assertEquals(MSACRobustKnownBiasAndFrameGyroscopeCalibrator.DEFAULT_THRESHOLD, calibrator.getThreshold(), 0.0);
        assertEquals(RobustEstimatorMethod.MSAC, calibrator.getMethod());
        assertEquals(0.0, calibrator.getBiasX(), 0.0);
        assertEquals(0.0, calibrator.getBiasY(), 0.0);
        assertEquals(0.0, calibrator.getBiasZ(), 0.0);
    ...
    void testConstructor4() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(measurements, this);
    ...
    void testConstructor5() throws WrongSizeException {
        final var calibrator = new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(true);
    ...
    void testConstructor6() throws WrongSizeException {
        final var calibrator = new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(true, this);
    ...
    void testConstructor7() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(measurements, true);
    ...
    void testConstructor9() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(biasX, biasY, biasZ);
    ...
    void testConstructor10() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(biasX, biasY, biasZ, this);
    ...
    void testConstructor11() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(measurements, biasX, biasY, biasZ);
    ...
    void testConstructor17() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(bx, by, bz);
    ...
    void testConstructor18() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(bx, by, bz, this);
    ...
    void testConstructor19() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(measurements, bx, by, bz);
    ...
    void testConstructor21() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(bx, by, bz, true);
    ...
    void testConstructor25() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(bias);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(new double[1]));
    }
    ...
    void testConstructor26() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(bias, this);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(
                new double[1], this));
    }
    ...
    void testConstructor27() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(measurements, bias);
    ...
    void testConstructor28() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(measurements, bias, this);
    ...
    void testConstructor29() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(bias, true);
    ...
    void testConstructor33() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(bg);
        ...
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(m1));
        final var m2 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(m2));
    }
    ...
    void testConstructor34() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(bg, this);
    ...
    void testConstructor35() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(measurements, bg);
    ...
    void testConstructor36() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(measurements, bg, this);
    ...
    void testConstructor37() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownBiasAndFrameGyroscopeCalibrator(bg, true);
    ...
    void testGetSetConfidence() throws LockedException {
        ...
        // check default value
        assertEquals(MSACRobustKnownBiasAndFrameGyroscopeCalibrator.DEFAULT_CONFIDENCE, calibrator.getConfidence(), 
                0.0);
    ...
    void testGetSetMaxIterations() throws LockedException {
        ...
        // check default value
        assertEquals(MSACRobustKnownBiasAndFrameGyroscopeCalibrator.DEFAULT_MAX_ITERATIONS,
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        ...
        // check default value
        assertEquals(MSACRobustKnownBiasAndFrameGyroscopeCalibrator.MINIMUM_MEASUREMENTS,
                calibrator.getPreliminarySubsetSize());
    ...
    private static void assertEstimatedResult(
            final Matrix mg, final Matrix gg, final MSACRobustKnownBiasAndFrameGyroscopeCalibrator calibrator) {
