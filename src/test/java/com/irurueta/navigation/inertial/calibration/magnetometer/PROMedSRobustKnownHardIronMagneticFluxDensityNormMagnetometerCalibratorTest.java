...
public class PROMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibratorTest implements
    ...
    public void testConstructor1() throws WrongSizeException {
        ...
        assertEquals(calibrator.getStopThreshold(),
                PROMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator.DEFAULT_STOP_THRESHOLD, 0.0);
        ...
        assertEquals(calibrator.getProgressDelta(),
                PROMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator.DEFAULT_PROGRESS_DELTA,
                0.0f);
        assertEquals(calibrator.getConfidence(),
                PROMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator.DEFAULT_CONFIDENCE,
                0.0);
        assertEquals(calibrator.getMaxIterations(),
                PROMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator.DEFAULT_MAX_ITERATIONS);
    ...
    public void testConstructor5() throws WrongSizeException {
        ...
        calibrator = null;
        try {
            calibrator = new PROMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator(
                    new double[1]);
    ...
    public void testConstructor23() throws WrongSizeException, IOException {
        ...
        PROMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator calibrator =
                new PROMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator(groundTruthMagneticFluxDensityNorm);
        ...
        calibrator = null;
        try {
            calibrator = new PROMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator(-1.0);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(calibrator);
    ...
    public void testGetSetStopThreshold() throws LockedException {
        ...
        // check default value
        assertEquals(calibrator.getStopThreshold(),
                PROMedSRobustKnownHardIronMagneticFluxDensityNormMagnetometerCalibrator.DEFAULT_STOP_THRESHOLD,
                0.0);
