...
class TurntableGyroscopeCalibratorTest implements TurntableGyroscopeCalibratorListener {
    ...
    void testConstructor1() throws WrongSizeException {
        final var calibrator = new TurntableGyroscopeCalibrator();
    ...
    void testConstructor2() throws WrongSizeException {
        ...
        final var calibrator = new TurntableGyroscopeCalibrator(ecefPosition, rotationRate, timeInterval, measurements,
                bg, mg, gg);
    ...
    void testConstructor18() throws WrongSizeException {
        ...
        final var calibrator = new TurntableGyroscopeCalibrator(nedPosition, rotationRate, timeInterval, measurements, 
                bg, mg, gg);
    ...
    void testCalibrateCommonAxisAndGDependentCrossBiasesDisabledAndNoNoise() throws WrongSizeException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var calibrator = new TurntableGyroscopeCalibrator(nedPosition, rotationRate, timeInterval,
