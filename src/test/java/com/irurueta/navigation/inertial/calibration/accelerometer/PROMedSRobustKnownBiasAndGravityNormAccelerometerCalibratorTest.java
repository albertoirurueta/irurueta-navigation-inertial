...
public class PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibratorTest implements
    ...
    public void testConstructor10() throws WrongSizeException {
        ...
        final PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator calibrator =
                new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(gravityNorm, measurements, this);
    ...
    public void testConstructor13() throws WrongSizeException {
        ...
        final PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator calibrator =
                new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(gravityNorm, measurements, bias);
    ...
    public void testConstructor15() throws WrongSizeException {
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(gravityNorm, measurements, true,
                        new double[1]));
    }
    ...
    public void testConstructor21() throws WrongSizeException {
        ...
        final PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator calibrator =
                new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(gravityNorm, measurements, ba, ma);
    ...
    public void testCalibrateGeneralNoNoiseInlier() throws WrongSizeException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator calibrator =
                    new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(qualityScores, gravity.getNorm(),
    ...
    public void testCalibrateCommonAxisNoNoiseInlier() throws WrongSizeException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator calibrator =
                    new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(
                            qualityScores, gravity.getNorm(), measurements, true, ba, ma, this);
            calibrator.setStopThreshold(THRESHOLD);
