...
class PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibratorTest implements
    ...
    void testConstructor1() throws WrongSizeException {
        final var calibrator = new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator();

        // check default values
        assertEquals(PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator.DEFAULT_STOP_THRESHOLD,
    ...
    void testConstructor2() throws WrongSizeException {
        final var calibrator = new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(this);
    ...
    void testConstructor3() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(measurements);
    ...
    void testConstructor4() throws WrongSizeException {
        final var calibrator = new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(true);
    ...
    void testConstructor5() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(bias);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(new double[1]));
    }
    ...
    void testConstructor6() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(ba);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(m1));
        final var m2 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(m2));
    }
    ...
    void testConstructor7() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(ba, ma);
        ...
        final var m1 = new Matrix(1, 1);
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(m1, ma));
        final var m2 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(m2, ma));
        final var m3 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(ba, m3));
        final var m4 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(ba, m4));
    }
    ...
    void testConstructor8() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(gravityNorm);
    ...
    void testConstructor13() throws WrongSizeException {
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(
    ...
    void testConstructor14() throws WrongSizeException {
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(gravityNorm, measurements,
                        new double[1], this));
    }
    ...
    void testConstructor17() throws WrongSizeException {
        ...
        final var m1 = new Matrix(1, 1);
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(gravityNorm, measurements, m1));
        final var m2 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(gravityNorm, measurements, m2));
    }
    ...
    void testConstructor21() throws WrongSizeException {
        ...
        final var m3 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(gravityNorm, measurements, ba,
                        m3));
        final var m4 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(gravityNorm, measurements, ba,
    ...
    void testConstructor42() throws WrongSizeException {
        ...
        final var calibrator = new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(qualityScores,
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(new double[9], gravityNorm,
                        measurements));
    }
    ...
    void testConstructor44() throws WrongSizeException {
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(new double[6], gravityNorm,
                        measurements, true));
    }
    ...
    void testConstructor46() throws WrongSizeException {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(new double[9], gravityNorm,
                        measurements, bias));
        assertThrows(IllegalArgumentException.class,
                () -> new PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator(qualityScores, gravityNorm,
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        ...
        // check default value
        assertEquals(PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator.MINIMUM_MEASUREMENTS_GENERAL,
                calibrator.getPreliminarySubsetSize());
    ...
    void testCalibrateGeneralNoNoiseInlier() throws WrongSizeException, InvalidSourceAndDestinationFrameTypeException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var errorRandomizer = new GaussianRandomizer(0.0, 
    ...
    private static void assertEstimatedResult(
            final Matrix ma, final PROMedSRobustKnownBiasAndGravityNormAccelerometerCalibrator calibrator) {
