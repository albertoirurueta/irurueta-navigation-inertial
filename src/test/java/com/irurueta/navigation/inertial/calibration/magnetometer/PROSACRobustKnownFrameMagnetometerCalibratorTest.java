...
class PROSACRobustKnownFrameMagnetometerCalibratorTest implements RobustKnownFrameMagnetometerCalibratorListener {
    ...
    void testConstructor1() throws WrongSizeException {
        final var calibrator = new PROSACRobustKnownFrameMagnetometerCalibrator();

        assertEquals(PROSACRobustKnownFrameMagnetometerCalibrator.DEFAULT_THRESHOLD, calibrator.getThreshold(),
                0.0);
        assertEquals(PROSACRobustKnownFrameMagnetometerCalibrator.DEFAULT_COMPUTE_AND_KEEP_INLIERS,
                calibrator.isComputeAndKeepInliersEnabled());
        assertEquals(PROSACRobustKnownFrameMagnetometerCalibrator.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS,
    ...
    void testConstructor2() throws WrongSizeException {
        final var calibrator = new PROSACRobustKnownFrameMagnetometerCalibrator(this);
    ...
    void testConstructor3() throws WrongSizeException {
        ...
        final var calibrator = new PROSACRobustKnownFrameMagnetometerCalibrator(measurements);
    ...
    void testConstructor4() throws WrongSizeException {
        ...
        final var calibrator = new PROSACRobustKnownFrameMagnetometerCalibrator(measurements, this);
    ...
    void testConstructor5() throws WrongSizeException {
        final var calibrator = new PROSACRobustKnownFrameMagnetometerCalibrator(true);
    ...
    void testConstructor6() throws WrongSizeException {
        final var calibrator = new PROSACRobustKnownFrameMagnetometerCalibrator(true, this);
    ...
    void testConstructor7() throws WrongSizeException {
        ...
        final var calibrator = new PROSACRobustKnownFrameMagnetometerCalibrator(measurements, true);
    ...
    void testConstructor9() throws WrongSizeException {
        final var qualityScores = new double[PROSACRobustKnownFrameMagnetometerCalibrator.MINIMUM_MEASUREMENTS];
        final var calibrator = new PROSACRobustKnownFrameMagnetometerCalibrator(qualityScores);
    ...
    void testConstructor10() throws WrongSizeException {
        final var qualityScores = new double[PROSACRobustKnownFrameMagnetometerCalibrator.MINIMUM_MEASUREMENTS];
        final var calibrator = new PROSACRobustKnownFrameMagnetometerCalibrator(qualityScores, this);
    ...
    void testConstructor11() throws WrongSizeException {
        ...
        final var calibrator = new PROSACRobustKnownFrameMagnetometerCalibrator(qualityScores, measurements);
    ...
    void testConstructor13() throws WrongSizeException {
        final var qualityScores = new double[PROSACRobustKnownFrameMagnetometerCalibrator.MINIMUM_MEASUREMENTS];
        final var calibrator = new PROSACRobustKnownFrameMagnetometerCalibrator(qualityScores, true);
    ...
    void testGetSetThreshold() throws LockedException {
        ...
        // check default value
        assertEquals(PROSACRobustKnownFrameMagnetometerCalibrator.DEFAULT_THRESHOLD, calibrator.getThreshold(), 0.0);
    ...
    void testIsReady() throws LockedException, IOException, InvalidSourceAndDestinationFrameTypeException {
        ...
        var qualityScores = new double[measurements.size() + 1];
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        ...
        // check default value
        assertEquals(PROSACRobustKnownFrameMagnetometerCalibrator.MINIMUM_MEASUREMENTS,
                calibrator.getPreliminarySubsetSize());
    ...
    @Test
    void testCalibrateCommonAxisNoNoiseInlier() throws IOException,
    ...
    public void onCalibrateNextIteration(
            final RobustKnownFrameMagnetometerCalibrator calibrator, final int iteration) {
        checkLocked((PROSACRobustKnownFrameMagnetometerCalibrator) calibrator);
    ...
    private void checkLocked(final PROSACRobustKnownFrameMagnetometerCalibrator calibrator) {
    ...
    private static void assertEstimatedResult(
            final Matrix hardIron, final Matrix mm, final PROSACRobustKnownFrameMagnetometerCalibrator calibrator,
    ...
    private static void assertCovariance(final PROSACRobustKnownFrameMagnetometerCalibrator calibrator) {
