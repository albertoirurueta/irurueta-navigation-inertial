...
class RANSACRobustTurntableGyroscopeCalibratorTest implements RobustTurntableGyroscopeCalibratorListener {
    ...
    void testConstructor1() throws WrongSizeException {
        final var calibrator = new RANSACRobustTurntableGyroscopeCalibrator();

        // check default values
        assertEquals(RANSACRobustTurntableGyroscopeCalibrator.DEFAULT_THRESHOLD, calibrator.getThreshold(), 0.0);
    ...
    void testConstructor2() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustTurntableGyroscopeCalibrator(ecefPosition, rotationRate, timeInterval,
        ...
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustTurntableGyroscopeCalibrator(ecefPosition,
    ...
    void testConstructor18() throws WrongSizeException {
        ...
        final var calibrator = new RANSACRobustTurntableGyroscopeCalibrator(nedPosition, rotationRate, timeInterval,
                measurements, bg, mg, gg);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustTurntableGyroscopeCalibrator(nedPosition,
                0.0, timeInterval, measurements, bg, mg, gg));
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustTurntableGyroscopeCalibrator(nedPosition,
                rotationRate, 0.0, measurements, bg, mg, gg));
        final var m1 = new Matrix(1, 1);
    ...
    void testConstructor25() throws WrongSizeException {
        ...
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustTurntableGyroscopeCalibrator(nedPosition,
                rotationRate, timeInterval, measurements, bg, mg, gg, m8, ma, this));
        final var m0 = new Matrix(1, 3);
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustTurntableGyroscopeCalibrator(nedPosition,
                rotationRate, timeInterval, measurements, bg, mg, gg, ba, m0, this));
        final var m10 = new Matrix(3, 1);
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustTurntableGyroscopeCalibrator(nedPosition,
                rotationRate, timeInterval, measurements, bg, mg, gg, ba, m10, this));
    }
    ...
    void testGetSetProgressDelta() throws LockedException {
        ...
        // check default value
        assertEquals(RANSACRobustTurntableGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA, calibrator.getProgressDelta(), 
                0.0);
    ...
    void testGetSetConfidence() throws LockedException {
        ...
        // check default value
        assertEquals(RANSACRobustTurntableGyroscopeCalibrator.DEFAULT_CONFIDENCE, calibrator.getConfidence(), 
                0.0);
    ...
    void testGetSetMaxIterations() throws LockedException {
        ...
        // check default value
        assertEquals(RANSACRobustTurntableGyroscopeCalibrator.DEFAULT_MAX_ITERATIONS, calibrator.getMaxIterations());
    ...
    private static void assertEstimatedResult(
            ...
            final RANSACRobustTurntableGyroscopeCalibrator calibrator, final boolean checkCovariance)
    ...
    private static void assertCovariance(final RANSACRobustTurntableGyroscopeCalibrator calibrator) {
