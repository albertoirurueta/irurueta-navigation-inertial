...
public class RANSACRobustTurntableGyroscopeCalibratorTest implements RobustTurntableGyroscopeCalibratorListener {
    ...
    public void testConstructor1() throws WrongSizeException {
        final RANSACRobustTurntableGyroscopeCalibrator calibrator = new RANSACRobustTurntableGyroscopeCalibrator();
    ...
    public void testConstructor2() throws WrongSizeException {
        ...
        final RANSACRobustTurntableGyroscopeCalibrator calibrator =
                new RANSACRobustTurntableGyroscopeCalibrator(ecefPosition, rotationRate, timeInterval, measurements,
                        bg, mg, gg);
    ...
    public void testConstructor31() throws WrongSizeException {
        ...
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustTurntableGyroscopeCalibrator(nedPosition,
                rotationRate, timeInterval, measurements, true, false,
                bias, mg, m4, accelerometerBias, ma, this));
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustTurntableGyroscopeCalibrator(nedPosition,
                rotationRate, timeInterval, measurements, true, false, bias,
                mg, gg, new double[1], ma, this));
        final var m5 = new Matrix(1, 3);
    ...
    public void testGetSetThreshold() throws LockedException {
        final RANSACRobustKnownFrameGyroscopeCalibrator calibrator = new RANSACRobustKnownFrameGyroscopeCalibrator();

        // check default value
        assertEquals(RANSACRobustKnownFrameGyroscopeCalibrator.DEFAULT_THRESHOLD,
    ...
    public void testGetSetConfidence() throws LockedException {
        ...
        // check default value
        assertEquals(RANSACRobustTurntableGyroscopeCalibrator.DEFAULT_CONFIDENCE, calibrator.getConfidence(), 0.0);
    ...
    @Test
    public void testGetSetAccelerometerScalingFactorsAndCrossCouplingErrors() throws WrongSizeException, LockedException {
        final RANSACRobustTurntableGyroscopeCalibrator calibrator = new RANSACRobustTurntableGyroscopeCalibrator();
