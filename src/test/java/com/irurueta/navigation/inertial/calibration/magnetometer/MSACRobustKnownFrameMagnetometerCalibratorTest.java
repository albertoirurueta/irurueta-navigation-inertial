...
class MSACRobustKnownFrameMagnetometerCalibratorTest implements RobustKnownFrameMagnetometerCalibratorListener {
    ...
    void testConstructor1() throws WrongSizeException {
        final var calibrator = new MSACRobustKnownFrameMagnetometerCalibrator();

        assertEquals(MSACRobustKnownFrameMagnetometerCalibrator.DEFAULT_THRESHOLD, calibrator.getThreshold(),
                0.0);
    ...
    void testConstructor2() throws WrongSizeException {
        final var calibrator = new MSACRobustKnownFrameMagnetometerCalibrator(this);
    ...
    void testConstructor3() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownFrameMagnetometerCalibrator(measurements);

        assertEquals(MSACRobustKnownFrameMagnetometerCalibrator.DEFAULT_THRESHOLD, calibrator.getThreshold(), 0.0);
        assertEquals(RobustEstimatorMethod.MSAC, calibrator.getMethod());
        assertEquals(0.0, calibrator.getInitialHardIronX(), 0.0);
        assertEquals(0.0, calibrator.getInitialHardIronY(), 0.0);
        assertEquals(0.0, calibrator.getInitialHardIronZ(), 0.0);
    ...
    void testConstructor4() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownFrameMagnetometerCalibrator(measurements, this);
    ...
    void testConstructor5() throws WrongSizeException {
        final var calibrator = new MSACRobustKnownFrameMagnetometerCalibrator(true);
    ...
    void testConstructor6() throws WrongSizeException {
        final var calibrator = new MSACRobustKnownFrameMagnetometerCalibrator(true, this);
    ...
    void testConstructor7() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownFrameMagnetometerCalibrator(measurements, true);
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        ...
        // check default value
        assertEquals(MSACRobustKnownFrameMagnetometerCalibrator.MINIMUM_MEASUREMENTS, 
                calibrator.getPreliminarySubsetSize());
    ...
    void testCalibrateGeneralNoNoiseInlier() throws IOException, InvalidSourceAndDestinationFrameTypeException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var calibrator = new MSACRobustKnownFrameMagnetometerCalibrator(measurements, false,
                    this);
    ...
    private void checkLocked(final MSACRobustKnownFrameMagnetometerCalibrator calibrator) {
    ...
    private static void assertEstimatedResult(
            final Matrix hardIron, final Matrix mm, final MSACRobustKnownFrameMagnetometerCalibrator calibrator,
    ...
    private static void assertCovariance(final MSACRobustKnownFrameMagnetometerCalibrator calibrator) {
