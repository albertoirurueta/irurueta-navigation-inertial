...
public class MSACRobustKnownFrameMagnetometerCalibratorTest implements RobustKnownFrameMagnetometerCalibratorListener {
    ...
    public void testConstructor1() throws WrongSizeException {
        final MSACRobustKnownFrameMagnetometerCalibrator calibrator = new MSACRobustKnownFrameMagnetometerCalibrator();
    ...
    public void testCalibrateGeneralNoNoiseInlier() throws IOException, InvalidSourceAndDestinationFrameTypeException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final MSACRobustKnownFrameMagnetometerCalibrator calibrator =
                    new MSACRobustKnownFrameMagnetometerCalibrator(measurements, false, this);
    ...
    public void testCalibrateCommonAxisNoNoiseInlier() throws IOException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final MSACRobustKnownFrameMagnetometerCalibrator calibrator =
                    new MSACRobustKnownFrameMagnetometerCalibrator(measurements, true, this);
            calibrator.setThreshold(THRESHOLD);
