...
class MSACRobustKnownFrameGyroscopeCalibratorTest implements RobustKnownFrameGyroscopeCalibratorListener {
    ...
    void testConstructor1() throws WrongSizeException {
        final var calibrator = new MSACRobustKnownFrameGyroscopeCalibrator();

        // check default values
        assertEquals(MSACRobustKnownFrameGyroscopeCalibrator.DEFAULT_THRESHOLD, calibrator.getThreshold(), 0.0);
    ...
    void testConstructor2() throws WrongSizeException {
        final var calibrator = new MSACRobustKnownFrameGyroscopeCalibrator(this);
    ...
    void testConstructor3() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownFrameGyroscopeCalibrator(measurements);
    ...
    void testConstructor4() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownFrameGyroscopeCalibrator(measurements, this);
    ...
    void testConstructor5() throws WrongSizeException {
        final var calibrator = new MSACRobustKnownFrameGyroscopeCalibrator(true);
    ...
    void testConstructor6() throws WrongSizeException {
        final var calibrator = new MSACRobustKnownFrameGyroscopeCalibrator(true, this);
    ...
    void testConstructor7() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownFrameGyroscopeCalibrator(measurements, true);
    ...
    void testGetSetProgressDelta() throws LockedException {
        ...
        // check default value
        assertEquals(MSACRobustKnownFrameGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA, calibrator.getProgressDelta(),
                0.0);
    ...
    void testGetSetConfidence() throws LockedException {
        ...
        // check default value
        assertEquals(MSACRobustKnownFrameGyroscopeCalibrator.DEFAULT_CONFIDENCE, calibrator.getConfidence(), 0.0);
    ...
    void testGetSetMaxIterations() throws LockedException {
        ...
        // check default value
        assertEquals(MSACRobustKnownFrameGyroscopeCalibrator.DEFAULT_MAX_ITERATIONS, calibrator.getMaxIterations());
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        ...
        // check default value
        assertEquals(MSACRobustKnownFrameGyroscopeCalibrator.MINIMUM_MEASUREMENTS, 
    ...
    void testCalibrateGeneralNoNoiseInlier() throws WrongSizeException, InvalidSourceAndDestinationFrameTypeException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var calibrator = new MSACRobustKnownFrameGyroscopeCalibrator(measurements, false,
                    this);
    ...
    private static void assertEstimatedResult(final Matrix bg, final Matrix mg, final Matrix gg,
            final MSACRobustKnownFrameGyroscopeCalibrator calibrator, final boolean checkCovariance)
    ...
    private static void assertCovariance(final MSACRobustKnownFrameGyroscopeCalibrator calibrator) {
