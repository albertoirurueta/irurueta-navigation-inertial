...
public class MSACRobustKnownFrameGyroscopeCalibratorTest implements RobustKnownFrameGyroscopeCalibratorListener {
    ...
    public void testConstructor1() throws WrongSizeException {
        final MSACRobustKnownFrameGyroscopeCalibrator calibrator = new MSACRobustKnownFrameGyroscopeCalibrator();
    ...
    public void testConstructor8() throws WrongSizeException {
        ...
        // check default values
        assertEquals(MSACRobustKnownFrameGyroscopeCalibrator.DEFAULT_THRESHOLD,
    ...
    public void testGetSetInitialBiasAsTriad() throws LockedException {
        ...
        final AngularSpeedTriad triad3 = new AngularSpeedTriad(AngularSpeedUnit.RADIANS_PER_SECOND, initialBiasX,
    ...
    public void testCalibrateGeneralNoNoiseInlier() throws WrongSizeException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final MSACRobustKnownFrameGyroscopeCalibrator calibrator =
                    new MSACRobustKnownFrameGyroscopeCalibrator(measurements, false, this);
