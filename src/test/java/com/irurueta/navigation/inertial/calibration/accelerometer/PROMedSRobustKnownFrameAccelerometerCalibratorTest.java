...
class PROMedSRobustKnownFrameAccelerometerCalibratorTest implements
    ...
    void testConstructor() throws WrongSizeException {
        ...
        var calibrator = new PROMedSRobustKnownFrameAccelerometerCalibrator();
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var calibrator = new PROMedSRobustKnownFrameAccelerometerCalibrator();
    ...
    void testCalibrateGeneralNoNoiseInlier() throws WrongSizeException, InvalidSourceAndDestinationFrameTypeException,
        ...
        final var calibrator = new PROMedSRobustKnownFrameAccelerometerCalibrator(qualityScores, measurements,
                false, this);
