...
class PROMedSRobustKnownBiasAndPositionAccelerometerCalibratorTest implements 
    ...
    void testConstructor5() throws WrongSizeException {
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustKnownBiasAndPositionAccelerometerCalibrator(
                new double[1]));
    }
    ...
    private static void assertEstimatedResult(
            final Matrix ma, final PROMedSRobustKnownBiasAndPositionAccelerometerCalibrator calibrator) {
