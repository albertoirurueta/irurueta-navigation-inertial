...
class LMedSRobustKnownFrameAccelerometerCalibratorTest implements RobustKnownFrameAccelerometerCalibratorListener {
    ...
    void testConstructor() throws WrongSizeException {
        ...
        var calibrator = new LMedSRobustKnownFrameAccelerometerCalibrator();

        // check default values
        assertEquals(LMedSRobustKnownFrameAccelerometerCalibrator.DEFAULT_STOP_THRESHOLD,
        ...
        calibrator = new LMedSRobustKnownFrameAccelerometerCalibrator(measurements, this);
        ...
        calibrator = new LMedSRobustKnownFrameAccelerometerCalibrator(true);
        ...
        calibrator = new LMedSRobustKnownFrameAccelerometerCalibrator(true, this);
        ...
        calibrator = new LMedSRobustKnownFrameAccelerometerCalibrator(measurements, true);
        ...
        // test constructor with measurements and common axis used
        calibrator = new LMedSRobustKnownFrameAccelerometerCalibrator(measurements, true, this);
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var calibrator = new LMedSRobustKnownFrameAccelerometerCalibrator();
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        ...
        // check default value
        assertEquals(LMedSRobustKnownFrameAccelerometerCalibrator.MINIMUM_MEASUREMENTS,
                calibrator.getPreliminarySubsetSize());
    ...
    void testCalibrateGeneralNoNoiseInlier() throws WrongSizeException, InvalidSourceAndDestinationFrameTypeException,
        ...
        final var calibrator = new LMedSRobustKnownFrameAccelerometerCalibrator(measurements, false,
                this);
    ...
    void testCalibrateCommonAxisNoNoiseInlier() throws WrongSizeException,
        ...
        final var calibrator = new LMedSRobustKnownFrameAccelerometerCalibrator(measurements, true,
                this);
        calibrator.setStopThreshold(THRESHOLD);
    ...
    private static void assertEstimatedResult(
            final Matrix ba, final Matrix ma, final LMedSRobustKnownFrameAccelerometerCalibrator calibrator,
    ...
    private static void assertCovariance(final LMedSRobustKnownFrameAccelerometerCalibrator calibrator) {
