...
class LMedSRobustKnownBiasEasyGyroscopeCalibratorTest implements RobustKnownBiasEasyGyroscopeCalibratorListener {
    ...
    void testConstructor1() throws WrongSizeException {
        final var calibrator = new LMedSRobustKnownBiasEasyGyroscopeCalibrator();
        ...
        assertEquals(LMedSRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_PROGRESS_DELTA, calibrator.getProgressDelta(),
                0.0);
        assertEquals(LMedSRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_CONFIDENCE, calibrator.getConfidence(),
                0.0);
        assertEquals(LMedSRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_MAX_ITERATIONS, calibrator.getMaxIterations());
        assertNull(calibrator.getInliersData());
        assertTrue(calibrator.isResultRefined());
        assertTrue(calibrator.isCovarianceKept());
        assertNull(calibrator.getQualityScores());
        assertEquals(LMedSRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_STOP_THRESHOLD, calibrator.getStopThreshold(),
                0.0);
    ...
    void testConstructor2() throws WrongSizeException {
        ...
        final var calibrator = new LMedSRobustKnownBiasEasyGyroscopeCalibrator(sequences, bg, mg, gg);
        ...
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustKnownBiasEasyGyroscopeCalibrator(sequences,
                m1, mg, gg));
    ...
    void testConstructor3() throws WrongSizeException {
        ...
        final var calibrator = new LMedSRobustKnownBiasEasyGyroscopeCalibrator(sequences, bg, mg, gg, this);
    ...
    void testConstructor4() throws WrongSizeException {
        ...
        final var calibrator = new LMedSRobustKnownBiasEasyGyroscopeCalibrator(sequences, bias, mg, gg);
        ...
        // Force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustKnownBiasEasyGyroscopeCalibrator(
    ...
    void testConstructor5() throws WrongSizeException {
        ...
        final var calibrator = new LMedSRobustKnownBiasEasyGyroscopeCalibrator(sequences, bias, mg, gg, this);
    ...
    void testConstructor6() throws WrongSizeException {
        ...
        final var calibrator = new LMedSRobustKnownBiasEasyGyroscopeCalibrator(sequences, bias, mg, gg, baArray, ma);
    ...
    void testConstructor8() throws WrongSizeException {
        ...
        final var calibrator = new LMedSRobustKnownBiasEasyGyroscopeCalibrator(sequences, bg, mg, gg, ba, ma);
    ...
    void testConstructor10() throws WrongSizeException {
        ...
        final var calibrator = new LMedSRobustKnownBiasEasyGyroscopeCalibrator(sequences, false,
                false, bg, mg, gg);
    ...
    void testConstructor12() throws WrongSizeException {
        ...
        assertTrue(calibrator.isCovarianceKept());
        assertNull(calibrator.getQualityScores());
        assertEquals(LMedSRobustKnownBiasEasyGyroscopeCalibrator.DEFAULT_STOP_THRESHOLD,
    ...
    void testCalibrateCommonAxisAndGDependentCrossBiasesDisabledAndNoInlierNoise() throws WrongSizeException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var calibrator = new LMedSRobustKnownBiasEasyGyroscopeCalibrator(sequences, true,
                    false, bg, mg, gg, ba, ma, this);
    ...
    private static void checkLocked(final LMedSRobustKnownBiasEasyGyroscopeCalibrator calibrator) {
