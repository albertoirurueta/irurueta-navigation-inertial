...
public class MSACRobustKnownHardIronAndFrameMagnetometerCalibratorTest implements
    ...
    public void testConstructor1() throws WrongSizeException {
        ...
        assertEquals(MSACRobustKnownHardIronAndFrameMagnetometerCalibrator.DEFAULT_THRESHOLD, calibrator.getThreshold(),
                0.0);
        ...
        assertEquals(RobustKnownHardIronAndFrameMagnetometerCalibrator.DEFAULT_CONFIDENCE,
    ...
    public void testConstructor2() throws WrongSizeException {
        final MSACRobustKnownHardIronAndFrameMagnetometerCalibrator calibrator =
                new MSACRobustKnownHardIronAndFrameMagnetometerCalibrator(this);
    ...
    public void testConstructor3() throws WrongSizeException {
        ...
        final MSACRobustKnownHardIronAndFrameMagnetometerCalibrator calibrator =
                new MSACRobustKnownHardIronAndFrameMagnetometerCalibrator(measurements);
    ...
    public void testConstructor4() throws WrongSizeException {
        ...
        final MSACRobustKnownHardIronAndFrameMagnetometerCalibrator calibrator =
                new MSACRobustKnownHardIronAndFrameMagnetometerCalibrator(measurements, this);
    ...
    public void testConstructor5() throws WrongSizeException {
        final MSACRobustKnownHardIronAndFrameMagnetometerCalibrator calibrator =
                new MSACRobustKnownHardIronAndFrameMagnetometerCalibrator(true);
    ...
    public void testConstructor6() throws WrongSizeException {
        final MSACRobustKnownHardIronAndFrameMagnetometerCalibrator calibrator =
                new MSACRobustKnownHardIronAndFrameMagnetometerCalibrator(true, this);
    ...
    public void testConstructor7() throws WrongSizeException {
        ...
        final MSACRobustKnownHardIronAndFrameMagnetometerCalibrator calibrator =
                new MSACRobustKnownHardIronAndFrameMagnetometerCalibrator(measurements, true);
    ...
    public void testGetHardIronAsMatrix() throws LockedException, WrongSizeException {
        ...
        assertThrows(IllegalArgumentException.class, () -> calibrator.setHardIron(new Matrix(1, 1)));
        assertThrows(IllegalArgumentException.class, () -> calibrator.setHardIron(new Matrix(1, 3)));
    }
    ...
    public void testGetSetPreliminarySubsetSize() throws LockedException {
        ...
        // check default value
        assertEquals(MSACRobustKnownHardIronAndFrameMagnetometerCalibrator.MINIMUM_MEASUREMENTS,
                calibrator.getPreliminarySubsetSize());
    ...
    public void testCalibrateGeneralNoNoiseInlier() throws IOException, InvalidSourceAndDestinationFrameTypeException,
        ...
        final MSACRobustKnownHardIronAndFrameMagnetometerCalibrator calibrator =
                new MSACRobustKnownHardIronAndFrameMagnetometerCalibrator(measurements, false,
                        this);
    ...
    private void checkLocked(final MSACRobustKnownHardIronAndFrameMagnetometerCalibrator calibrator) {
    ...
    private static void assertEstimatedResult(
            final Matrix mm, final MSACRobustKnownHardIronAndFrameMagnetometerCalibrator calibrator) {
