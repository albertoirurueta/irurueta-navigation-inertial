...
class MSACRobustKnownHardIronAndFrameMagnetometerCalibratorTest implements
    ...
    void testConstructor1() throws WrongSizeException {
        final var calibrator = new MSACRobustKnownHardIronAndFrameMagnetometerCalibrator();
    ...
    void testConstructor2() throws WrongSizeException {
        final var calibrator = new MSACRobustKnownHardIronAndFrameMagnetometerCalibrator(this);
    ...
    void testConstructor3() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownHardIronAndFrameMagnetometerCalibrator(measurements);
    ...
    void testConstructor4() throws WrongSizeException {
        ...
        final var calibrator = new MSACRobustKnownHardIronAndFrameMagnetometerCalibrator(measurements, this);
    ...
    void testConstructor5() throws WrongSizeException {
        final var calibrator = new MSACRobustKnownHardIronAndFrameMagnetometerCalibrator(true);
    ...
    void testGetHardIronAsMatrix() throws LockedException, WrongSizeException {
        ...
        assertThrows(IllegalArgumentException.class, () -> calibrator.setHardIron(m1));
