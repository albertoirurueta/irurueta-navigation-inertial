...
class AccumulatedAngularSpeedTriadNoiseEstimatorTest implements AccumulatedAngularSpeedTriadNoiseEstimatorListener {
    ...
    void testConstructor1() {
        final var estimator = new AccumulatedAngularSpeedTriadNoiseEstimator();
    ...
    void testConstructor2() {
        final var estimator = new AccumulatedAngularSpeedTriadNoiseEstimator(this);
    ...
    void testAddTriadAndReset1() throws LockedException, WrongSizeException {
        ...
        final var avgNorm2 = new AngularSpeed(1.0, AngularSpeedUnit.RADIANS_PER_SECOND);
    ...
    private void checkLocked(final AccumulatedAngularSpeedTriadNoiseEstimator estimator) {
        ...
        assertThrows(LockedException.class, () -> estimator.addTriad(new AngularSpeedTriad()));
