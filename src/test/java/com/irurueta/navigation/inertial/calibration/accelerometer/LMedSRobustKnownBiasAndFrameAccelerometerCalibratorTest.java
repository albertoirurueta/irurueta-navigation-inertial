...
class LMedSRobustKnownBiasAndFrameAccelerometerCalibratorTest implements 
    ...
    void testConstructor() throws WrongSizeException {
        ...
        var calibrator = new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator();

        // check default values
        assertEquals(LMedSRobustKnownBiasAndFrameAccelerometerCalibrator.DEFAULT_STOP_THRESHOLD,
        ...
        calibrator = new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(measurements, this);
        ...
        calibrator = new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(true);
        ...
        calibrator = new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(true, this);
        ...
        calibrator = new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(measurements, true);
        ...
        calibrator = new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(biasX, biasY, biasZ);
        ...
        calibrator = new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(biasX, biasY, biasZ, this);
        ...
        calibrator = new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(measurements, biasX, biasY, biasZ);
        ...
        calibrator = new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(biasX, biasY, biasZ, true);
        ...
        calibrator = new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(bax, bay, baz);
        ...
        calibrator = new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(bax, bay, baz, this);
        ...
        calibrator = new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(measurements, bax, bay, baz);
        ...
        calibrator = new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(measurements, bax, bay, baz, this);
        ...
        calibrator = new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(bax, bay, baz, true);
        ...
        calibrator = new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(biasArray);
        ...
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(
                new double[1]));

        // test constructor with bias array and listener
        calibrator = new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(biasArray, this);
        ...
        calibrator = new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(measurements, biasArray);
        ...
        calibrator = new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(measurements, biasArray, this);
        ...
        calibrator = new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(biasArray, true);
        ...
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(m1));
        final var m2 = new Matrix(3, 3);
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(m2));
        ...
        calibrator = new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(measurements, ba, this);
        ...
        calibrator = new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(ba, true);
        ...
        calibrator = new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(ba, true, this);
        ...
        calibrator = new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(measurements, ba, true);
    ...
    void testGetSetThreshold() throws LockedException {
        final var calibrator = new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator();
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        ...
        // check default value
        assertEquals(LMedSRobustKnownBiasAndFrameAccelerometerCalibrator.MINIMUM_MEASUREMENTS,
                calibrator.getPreliminarySubsetSize());
    ...
    void testCalibrateGeneralNoNoiseInlier() throws WrongSizeException, InvalidSourceAndDestinationFrameTypeException,
        ...
        final var biasY = ba.getElementAtIndex(1);
        final var biasZ = ba.getElementAtIndex(2);
        final var calibrator = new LMedSRobustKnownBiasAndFrameAccelerometerCalibrator(measurements,
    ...
    void testCalibrateGeneralNoRefinement() throws WrongSizeException, InvalidSourceAndDestinationFrameTypeException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var errorsOutlier = new IMUErrors(ba, bg, ma, mg, gg, accelNoiseRootPSD, gyroNoiseRootPSD,
                    accelQuantLevel, gyroQuantLevel);
            final var errorsInlier = new IMUErrors(ba, bg, ma, mg, gg, 0.0,
    ...
    private static void assertEstimatedResult(
            final Matrix ma, final LMedSRobustKnownBiasAndFrameAccelerometerCalibrator calibrator) {
