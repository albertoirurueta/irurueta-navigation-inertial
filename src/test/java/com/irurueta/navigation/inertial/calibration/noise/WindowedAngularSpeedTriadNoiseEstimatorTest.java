...
class WindowedAngularSpeedTriadNoiseEstimatorTest implements WindowedAngularSpeedTriadNoiseEstimatorListener {
    ...
    void testConstructor1() {
        final var estimator = new WindowedAngularSpeedTriadNoiseEstimator();
        ...
        final var avgX2 = new AngularSpeed(1.0, AngularSpeedUnit.RADIANS_PER_SECOND);
        ...
        final var avgY2 = new AngularSpeed(1.0, AngularSpeedUnit.RADIANS_PER_SECOND);
        ...
        final var avgZ2 = new AngularSpeed(1.0, AngularSpeedUnit.RADIANS_PER_SECOND);
        ...
        final var stdX2 = new AngularSpeed(1.0, AngularSpeedUnit.RADIANS_PER_SECOND);
        ...
        final var stdY2 = new AngularSpeed(1.0, AngularSpeedUnit.RADIANS_PER_SECOND);
        ...
        final var stdZ2 = new AngularSpeed(1.0, AngularSpeedUnit.RADIANS_PER_SECOND);
        ...
        final var stdNorm2 = new AngularSpeed(1.0, AngularSpeedUnit.DEGREES_PER_SECOND);
        ...
        final var avgStd2 = new AngularSpeed(1.0, AngularSpeedUnit.DEGREES_PER_SECOND);
    ...
    void testConstructor2() {
        final var estimator = new WindowedAngularSpeedTriadNoiseEstimator(this);
        ...
        assertEquals(0.0, avgX1.getValue().doubleValue(), 0.0);
        assertEquals(AngularSpeedUnit.RADIANS_PER_SECOND, avgX1.getUnit());
        final var avgX2 = new AngularSpeed(1.0, AngularSpeedUnit.DEGREES_PER_SECOND);
        estimator.getAvgXAsMeasurement(avgX2);
        assertEquals(avgX1, avgX2);
        assertEquals(0.0, estimator.getAvgY(), 0.0);
        final var avgY1 = estimator.getAvgYAsMeasurement();
        assertEquals(0.0, avgY1.getValue().doubleValue(), 0.0);
        assertEquals(AngularSpeedUnit.RADIANS_PER_SECOND, avgY1.getUnit());
        final var avgY2 = new AngularSpeed(1.0, AngularSpeedUnit.DEGREES_PER_SECOND);
        estimator.getAvgYAsMeasurement(avgY2);
        assertEquals(avgY1, avgY2);
        assertEquals(0.0, estimator.getAvgZ(), 0.0);
        final var avgZ1 = estimator.getAvgZAsMeasurement();
        assertEquals(0.0, avgZ1.getValue().doubleValue(), 0.0);
        assertEquals(AngularSpeedUnit.RADIANS_PER_SECOND, avgZ1.getUnit());
        final var avgZ2 = new AngularSpeed(1.0, AngularSpeedUnit.DEGREES_PER_SECOND);
        estimator.getAvgZAsMeasurement(avgZ2);
        assertEquals(avgZ1, avgZ2);
        final var triad1 = estimator.getAvgTriad();
        assertEquals(0.0, triad1.getValueX(), 0.0);
    ...
    void testAddTriadAndProcessAndThenReset1() throws WrongSizeException, LockedException {
        ...
        final var firstTriad = new AngularSpeedTriad();
        final var lastTriad = new AngularSpeedTriad();
        ...
        var avgWy = 0.0;
        var avgWz = 0.0;
        final var triads = new ArrayList<AngularSpeedTriad>();
        ...
        for (var i = 0; i < windowSize; i++) {
            ...
            final var diffX = valueX - avgWx;
            final var diffY = valueY - avgWy;
            final var diffZ = valueZ - avgWz;
        ...
        var w1 = estimator.getAvgXAsMeasurement();
        ...
        assertEquals(AngularSpeedUnit.RADIANS_PER_SECOND, norm1.getUnit());
        final var norm2 = new AngularSpeed(1.0, AngularSpeedUnit.DEGREES_PER_SECOND);
        estimator.getAvgNormAsMeasurement(norm2);
        assertEquals(norm1, norm2);
        ...
        final var avgStd = (stdWx + stdWy + stdWz) / 3.0;
        ...
        final var psdX = varWx * timeInterval;
        final var psdY = varWy * timeInterval;
        final var psdZ = varWz * timeInterval;
