...
public class PROMedSRobustKnownPositionAccelerometerCalibrator extends RobustKnownPositionAccelerometerCalibrator {
     ...
     */
    public PROMedSRobustKnownPositionAccelerometerCalibrator(final boolean commonAxisUsed) {
     ...
     */
    public PROMedSRobustKnownPositionAccelerometerCalibrator(final double[] initialBias) {
        super(initialBias);
    }
     ...
     */
    public PROMedSRobustKnownPositionAccelerometerCalibrator(final Matrix initialBias) {
        super(initialBias);
    }
     ...
     */
    public PROMedSRobustKnownPositionAccelerometerCalibrator(final Matrix initialBias, final Matrix initialMa) {
     ...
     */
    public PROMedSRobustKnownPositionAccelerometerCalibrator(final ECEFPosition position) {
        super(position);
    }
     ...
     * @param position position where body kinematics measures have been taken.
     */
    public PROMedSRobustKnownPositionAccelerometerCalibrator(final NEDPosition position) {
        super(position);
    }
