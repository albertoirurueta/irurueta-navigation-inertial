 ...
 */
public class PROSACRobustKnownFrameMagnetometerCalibrator extends RobustKnownFrameMagnetometerCalibrator {
     ...
     */
    public PROSACRobustKnownFrameMagnetometerCalibrator(final RobustKnownFrameMagnetometerCalibratorListener listener) {
        super(listener);
    }
     ...
     */
    public PROSACRobustKnownFrameMagnetometerCalibrator(final double[] qualityScores) {
        super();
     ...
     *                                  is smaller than 4 samples.
     */
    public PROSACRobustKnownFrameMagnetometerCalibrator(final double[] qualityScores, final boolean commonAxisUsed) {
        super(commonAxisUsed);
        internalSetQualityScores(qualityScores);
    }
            ...
            public void onEstimateNextIteration(
                ...
                if (listener != null) {
                    listener.onCalibrateNextIteration(
                            PROSACRobustKnownFrameMagnetometerCalibrator.this, iteration);
                }
            }
