 ...
 */
public class AngularSpeedTriadStaticIntervalDetector extends TriadStaticIntervalDetector<AngularSpeedUnit, AngularSpeed,
        AngularSpeedTriad, AngularSpeedTriadStaticIntervalDetector, AngularSpeedTriadStaticIntervalDetectorListener>
    ...
    public AngularSpeedTriadStaticIntervalDetector() {
        super(new WindowedAngularSpeedTriadNoiseEstimator(), new AccumulatedAngularSpeedTriadNoiseEstimator());
    }
     ...
     */
    public AngularSpeedTriadStaticIntervalDetector(final AngularSpeedTriadStaticIntervalDetectorListener listener) {
        super(new WindowedAngularSpeedTriadNoiseEstimator(), new AccumulatedAngularSpeedTriadNoiseEstimator(),
                listener);
    }
     ...
     */
    @Override
    protected double convertMeasurement(final double value, final AngularSpeedUnit unit) {
