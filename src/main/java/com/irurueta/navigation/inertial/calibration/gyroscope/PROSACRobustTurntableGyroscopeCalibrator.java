 ...
 */
public class PROSACRobustTurntableGyroscopeCalibrator extends RobustTurntableGyroscopeCalibrator {
     ...
     */
    public PROSACRobustTurntableGyroscopeCalibrator(final double[] qualityScores) {
        super();
