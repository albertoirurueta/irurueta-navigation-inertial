...
public interface AccelerometerNonLinearCalibrator extends AccelerometerCalibrator {
     ...
     */
    int getEstimatedChiSqDegreesOfFreedom();
     ...
     */
    double getEstimatedReducedChiSq();
     ...
     *
     * @return estimated probability of finding a smaller chi square value or null if there were numerical unstabilities
     * to compute such value.
     */
    double getEstimatedP();
