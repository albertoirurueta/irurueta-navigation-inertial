 ...
 */
public class PROMedSRobustKnownBiasEasyGyroscopeCalibrator extends RobustKnownBiasEasyGyroscopeCalibrator {
     ...
     *                                  is smaller than 10.
     */
    public PROMedSRobustKnownBiasEasyGyroscopeCalibrator(final double[] qualityScores) {
        super();
