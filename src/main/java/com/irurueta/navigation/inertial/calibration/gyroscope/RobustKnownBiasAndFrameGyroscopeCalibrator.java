    ...
    protected void computePreliminarySolutions(final int[] samplesIndices, final List<PreliminaryResult> solutions) {
        ...
        try {
            ...
            if (refinePreliminarySolutions) {
                ...
                result.estimatedChiSqDegreesOfFreedom = nonLinearCalibrator.getEstimatedChiSqDegreesOfFreedom();
                result.estimatedReducedChiSq = nonLinearCalibrator.getEstimatedReducedChiSq();
                result.estimatedP = nonLinearCalibrator.getEstimatedP();
                result.estimatedQ = nonLinearCalibrator.getEstimatedQ();

            } else {
                result.covariance = null;
                result.estimatedMse = 0.0;
                result.estimatedChiSq = 0.0;
                result.estimatedChiSqDegreesOfFreedom = 0;
                result.estimatedReducedChiSq = 0.0;
                result.estimatedP = 1.0;
                result.estimatedQ = 0.0;
            }
